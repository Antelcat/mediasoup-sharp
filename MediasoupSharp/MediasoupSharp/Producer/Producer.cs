...
namespace MediasoupSharp.Producer
{
    public class Producer : EventEmitter
    {
        ...
        )
        {
            ...
            if (_isCheckConsumer)
            {
                _checkConsumersTimer = new Timer(CheckConsumers, null, TimeSpan.FromSeconds(CheckConsumersTimeSeconds),
        ...
        private void CloseInternal()
        {
            ...
            // Fire and forget
            _channel.RequestAsync(MethodId.TRANSPORT_CLOSE_PRODUCER, _internal.RouterId, reqData)
...
#pragma warning restore VSTHRD100 // Avoid async void methods
        {
            ...
            await using (await _closeLock.WriteLockAsync())
            {
                ...
                {
                    _checkConsumersTimer?.Change(TimeSpan.FromSeconds(CheckConsumersTimeSeconds),
                        TimeSpan.FromMilliseconds(-1));
                }
            }
        }
