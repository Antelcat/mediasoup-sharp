...
namespace MediasoupSharp.Worker
{
    ...
    public class Worker : WorkerBase
    {
        ...
        public Worker(ILoggerFactory loggerFactory, MediasoupOptions mediasoupOptions) : base(loggerFactory, mediasoupOptions)
        {
            ...
            _channel = new Channel.Channel(_loggerFactory.CreateLogger<Channel.Channel>(), _pipes[3], _pipes[4], ProcessId);
            _channel.MessageEvent += OnChannelMessage;

            _payloadChannel = new PayloadChannel.PayloadChannel(_loggerFactory.CreateLogger<PayloadChannel.PayloadChannel>(), _pipes[5], _pipes[6], ProcessId);
