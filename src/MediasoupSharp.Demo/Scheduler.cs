...
namespace MediasoupSharp.Demo
{
    public class Scheduler
    {
        ...
        public async Task<WebRtcTransport.WebRtcTransport> CreateWebRtcTransportAsync(string peerId, string connectionId, CreateWebRtcTransportRequest createWebRtcTransportRequest, bool isSend)
        {
            await using(await _peersLock.ReadLockAsync())
            {
                if(!_peers.TryGetValue(peerId, out var peer))
        ...
        public async Task<PlainTransport.PlainTransport> CreatePlainTransportAsync(string peerId, string connectionId, CreatePlainTransportRequest createPlainTransportRequest)
        {
            await using(await _peersLock.ReadLockAsync())
            {
                if(!_peers.TryGetValue(peerId, out var peer))
        ...
        public async Task<Consumer.Consumer?> ConsumeAsync(string producerPeerId, string consumerPeerId, string producerId)
        {
            await using(await _peersLock.ReadLockAsync())
            {
                ...
                if(!_peers.TryGetValue(consumerPeerId, out var cosumerPeer))
                {
        ...
        public async Task<Consumer.Consumer> ResumeConsumerAsync(string peerId, string connectionId, string consumerId)
        {
            await using(await _peersLock.ReadLockAsync())
            {
                if(!_peers.TryGetValue(peerId, out var peer))
        ...
        public async Task<bool> SetConsumerPreferedLayersAsync(string peerId, string connectionId, SetConsumerPreferredLayersRequest setConsumerPreferedLayersRequest)
        {
            await using(await _peersLock.ReadLockAsync())
            {
                if(!_peers.TryGetValue(peerId, out var peer))
                ...
                return await peer.SetConsumerPreferredLayersAsync(setConsumerPreferedLayersRequest);
            }
        }
