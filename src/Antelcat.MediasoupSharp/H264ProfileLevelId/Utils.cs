...
public static class Utils
{
    ...
    [
        new(0x42, new BitPattern("x1xx0000"), Profile.ConstrainedBaseline),
        new(0x4D, new BitPattern("1xxx0000"), Profile.ConstrainedBaseline),
        new(0x58, new BitPattern("11xx0000"), Profile.ConstrainedBaseline),
        new(0x42, new BitPattern("x0xx0000"), Profile.Baseline),
        new(0x58, new BitPattern("10xx0000"), Profile.Baseline),
        new(0x4D, new BitPattern("0x0x0000"), Profile.Main),
        new(0x64, new BitPattern("00000000"), Profile.High),
        new(0x64, new BitPattern("00001100"), Profile.ConstrainedHigh),
