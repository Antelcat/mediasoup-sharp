...
namespace FlatBuffers.Common
{
  ...
  public Span<byte> GetKeyBytes() { return __p.__vector_as_span<byte>(4, 1); }
        ...
        public static Offset<StringStringArray> CreateStringStringArray(FlatBufferBuilder builder,
        ...
        public static Offset<StringStringArray> EndStringStringArray(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // key
            builder.Required(o, 6);  // values
            return new Offset<StringStringArray>(o);
        }
        ...
        public static Offset<StringStringArray> Pack(FlatBufferBuilder builder, StringStringArrayT _o)
        {
            if(_o == null)
                return default(Offset<StringStringArray>);
