...
namespace FlatBuffers.Common
{
  ...
  public Span<byte> GetValueBytes() { return __p.__vector_as_span<byte>(6, 1); }
        ...
        public static Offset<Uint32String> CreateUint32String(FlatBufferBuilder builder,
                                                              uint key = 0,
        ...
        public static Offset<Uint32String> EndUint32String(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 6);  // value
            return new Offset<Uint32String>(o);
        }
        ...
        public static Offset<Uint32String> Pack(FlatBufferBuilder builder, Uint32StringT _o)
        {
            if(_o == null)
                return default(Offset<Uint32String>);
