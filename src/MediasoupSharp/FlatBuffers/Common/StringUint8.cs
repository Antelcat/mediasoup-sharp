...
namespace FlatBuffers.Common
{
  ...
  public Span<byte> GetKeyBytes() { return __p.__vector_as_span<byte>(4, 1); }
        ...
        public static Offset<StringUint8> CreateStringUint8(FlatBufferBuilder builder,
        ...
        public static Offset<StringUint8> EndStringUint8(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // key
            return new Offset<StringUint8>(o);
        }
        ...
        public static Offset<StringUint8> Pack(FlatBufferBuilder builder, StringUint8T _o)
        {
            if(_o == null)
                return default(Offset<StringUint8>);
