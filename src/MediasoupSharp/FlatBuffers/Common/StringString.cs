...
namespace FlatBuffers.Common
{
  ...
  public Span<byte> GetValueBytes() { return __p.__vector_as_span<byte>(6, 1); }
        ...
        public static Offset<StringString> CreateStringString(FlatBufferBuilder builder,
        ...
        public static Offset<StringString> EndStringString(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // key
            builder.Required(o, 6);  // value
            return new Offset<StringString>(o);
        }
        ...
        public static Offset<StringString> Pack(FlatBufferBuilder builder, StringStringT _o)
        {
            if(_o == null)
                return default(Offset<StringString>);
