...
namespace FlatBuffers.Router
{
  ...
  public Span<byte> GetIdBytes() { return __p.__vector_as_span<byte>(4, 1); }
        ...
        public StringStringArray? MapProducerIdConsumerIds(int j) { int o = __p.__offset(10); return o != 0 ? (StringStringArray?)(new StringStringArray()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
        public int MapProducerIdConsumerIdsLength { get { int o = __p.__offset(10); return o != 0 ? __p.__vector_len(o) : 0; } }
        public StringString? MapConsumerIdProducerId(int j) { int o = __p.__offset(12); return o != 0 ? (StringString?)(new StringString()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
        public int MapConsumerIdProducerIdLength { get { int o = __p.__offset(12); return o != 0 ? __p.__vector_len(o) : 0; } }
        public StringStringArray? MapProducerIdObserverIds(int j) { int o = __p.__offset(14); return o != 0 ? (StringStringArray?)(new StringStringArray()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
        public int MapProducerIdObserverIdsLength { get { int o = __p.__offset(14); return o != 0 ? __p.__vector_len(o) : 0; } }
        public StringStringArray? MapDataProducerIdDataConsumerIds(int j) { int o = __p.__offset(16); return o != 0 ? (StringStringArray?)(new StringStringArray()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
        public int MapDataProducerIdDataConsumerIdsLength { get { int o = __p.__offset(16); return o != 0 ? __p.__vector_len(o) : 0; } }
        public StringString? MapDataConsumerIdDataProducerId(int j) { int o = __p.__offset(18); return o != 0 ? (StringString?)(new StringString()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
        ...
        public static VectorOffset CreateMapProducerIdConsumerIdsVector(FlatBufferBuilder builder, Offset<StringStringArray>[] data) { builder.StartVector(4, data.Length, 4); for(int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
        public static VectorOffset CreateMapProducerIdConsumerIdsVectorBlock(FlatBufferBuilder builder, Offset<StringStringArray>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
        public static VectorOffset CreateMapProducerIdConsumerIdsVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<StringStringArray>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
        public static VectorOffset CreateMapProducerIdConsumerIdsVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<StringStringArray>>(dataPtr, sizeInBytes); return builder.EndVector(); }
        ...
        public static VectorOffset CreateMapConsumerIdProducerIdVector(FlatBufferBuilder builder, Offset<StringString>[] data) { builder.StartVector(4, data.Length, 4); for(int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
        public static VectorOffset CreateMapConsumerIdProducerIdVectorBlock(FlatBufferBuilder builder, Offset<StringString>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
        public static VectorOffset CreateMapConsumerIdProducerIdVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<StringString>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
        public static VectorOffset CreateMapConsumerIdProducerIdVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<StringString>>(dataPtr, sizeInBytes); return builder.EndVector(); }
        ...
        public static VectorOffset CreateMapProducerIdObserverIdsVector(FlatBufferBuilder builder, Offset<StringStringArray>[] data) { builder.StartVector(4, data.Length, 4); for(int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
        public static VectorOffset CreateMapProducerIdObserverIdsVectorBlock(FlatBufferBuilder builder, Offset<StringStringArray>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
        public static VectorOffset CreateMapProducerIdObserverIdsVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<StringStringArray>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
        public static VectorOffset CreateMapProducerIdObserverIdsVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<StringStringArray>>(dataPtr, sizeInBytes); return builder.EndVector(); }
        ...
        public static VectorOffset CreateMapDataProducerIdDataConsumerIdsVector(FlatBufferBuilder builder, Offset<StringStringArray>[] data) { builder.StartVector(4, data.Length, 4); for(int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
        public static VectorOffset CreateMapDataProducerIdDataConsumerIdsVectorBlock(FlatBufferBuilder builder, Offset<StringStringArray>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
        public static VectorOffset CreateMapDataProducerIdDataConsumerIdsVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<StringStringArray>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
        public static VectorOffset CreateMapDataProducerIdDataConsumerIdsVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<StringStringArray>>(dataPtr, sizeInBytes); return builder.EndVector(); }
        ...
        public static VectorOffset CreateMapDataConsumerIdDataProducerIdVector(FlatBufferBuilder builder, Offset<StringString>[] data) { builder.StartVector(4, data.Length, 4); for(int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
        public static VectorOffset CreateMapDataConsumerIdDataProducerIdVectorBlock(FlatBufferBuilder builder, Offset<StringString>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
        public static VectorOffset CreateMapDataConsumerIdDataProducerIdVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<StringString>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
        public static VectorOffset CreateMapDataConsumerIdDataProducerIdVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<StringString>>(dataPtr, sizeInBytes); return builder.EndVector(); }
        ...
        public void UnPackTo(DumpResponseT _o)
        {
            ...
            _o.MapProducerIdConsumerIds = new List<StringStringArrayT>();
            ...
            _o.MapConsumerIdProducerId = new List<StringStringT>();
            ...
            _o.MapProducerIdObserverIds = new List<StringStringArrayT>();
            ...
            _o.MapDataProducerIdDataConsumerIds = new List<StringStringArrayT>();
            ...
            _o.MapDataConsumerIdDataProducerId = new List<StringStringT>();
        ...
        public static Offset<DumpResponse> Pack(FlatBufferBuilder builder, DumpResponseT _o)
        {
            ...
            {
                var __map_producer_id_consumer_ids = new Offset<StringStringArray>[_o.MapProducerIdConsumerIds.Count];
                for(var _j = 0; _j < __map_producer_id_consumer_ids.Length; ++_j)
                { __map_producer_id_consumer_ids[_j] = StringStringArray.Pack(builder, _o.MapProducerIdConsumerIds[_j]); }
            ...
            {
                var __map_consumer_id_producer_id = new Offset<StringString>[_o.MapConsumerIdProducerId.Count];
                for(var _j = 0; _j < __map_consumer_id_producer_id.Length; ++_j)
                { __map_consumer_id_producer_id[_j] = StringString.Pack(builder, _o.MapConsumerIdProducerId[_j]); }
            ...
            {
                var __map_producer_id_observer_ids = new Offset<StringStringArray>[_o.MapProducerIdObserverIds.Count];
                for(var _j = 0; _j < __map_producer_id_observer_ids.Length; ++_j)
                { __map_producer_id_observer_ids[_j] = StringStringArray.Pack(builder, _o.MapProducerIdObserverIds[_j]); }
            ...
            {
                var __map_data_producer_id_data_consumer_ids = new Offset<StringStringArray>[_o.MapDataProducerIdDataConsumerIds.Count];
                for(var _j = 0; _j < __map_data_producer_id_data_consumer_ids.Length; ++_j)
                { __map_data_producer_id_data_consumer_ids[_j] = StringStringArray.Pack(builder, _o.MapDataProducerIdDataConsumerIds[_j]); }
            ...
            {
                var __map_data_consumer_id_data_producer_id = new Offset<StringString>[_o.MapDataConsumerIdDataProducerId.Count];
                for(var _j = 0; _j < __map_data_consumer_id_data_producer_id.Length; ++_j)
                { __map_data_consumer_id_data_producer_id[_j] = StringString.Pack(builder, _o.MapDataConsumerIdDataProducerId[_j]); }
    ...
    public class DumpResponseT
    {
        ...
        public List<StringStringArrayT> MapProducerIdConsumerIds { get; set; }
        ...
        public List<StringStringT> MapConsumerIdProducerId { get; set; }
        ...
        public List<StringStringArrayT> MapProducerIdObserverIds { get; set; }
        ...
        public List<StringStringArrayT> MapDataProducerIdDataConsumerIds { get; set; }
        ...
        public List<StringStringT> MapDataConsumerIdDataProducerId { get; set; }
