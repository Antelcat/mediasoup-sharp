...
namespace FlatBuffers.Router
{
  ...
  public Span<byte> GetTransportIdBytes() { return __p.__vector_as_span<byte>(4, 1); }
    ...
    public static Offset<CloseTransportRequest> CreateCloseTransportRequest( FlatBufferBuilder builder,
    ...
    public static Offset<CloseTransportRequest> EndCloseTransportRequest( FlatBufferBuilder builder )
    {
      int o = builder.EndTable();
      builder.Required( o, 4 );  // transport_id
      return new Offset<CloseTransportRequest>( o );
    }
    ...
    public static Offset<CloseTransportRequest> Pack( FlatBufferBuilder builder, CloseTransportRequestT _o )
    {
      if ( _o == null )
        return default( Offset<CloseTransportRequest> );
