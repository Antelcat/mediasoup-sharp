...
namespace FlatBuffers.Router
{
  ...
  public Span<byte> GetRtpObserverIdBytes() { return __p.__vector_as_span<byte>(4, 1); }
    ...
    public ActiveSpeakerObserverOptions? Options { get { int o = __p.__offset( 6 ); return o != 0 ? ( ActiveSpeakerObserverOptions? ) (new ActiveSpeakerObserverOptions()).__assign( __p.__indirect( o + __p.bb_pos ), __p.bb ) : null; } }

    public static Offset<CreateActiveSpeakerObserverRequest> CreateCreateActiveSpeakerObserverRequest( FlatBufferBuilder builder,
                                                                                                       StringOffset rtp_observer_idOffset = default( StringOffset ),
                                                                                                       Offset<ActiveSpeakerObserverOptions> optionsOffset = default( Offset<ActiveSpeakerObserverOptions> ) )
    {
    ...
    public static void AddOptions( FlatBufferBuilder builder, Offset<ActiveSpeakerObserverOptions> optionsOffset ) { builder.AddOffset( 1, optionsOffset.Value, 0 ); }
    public static Offset<CreateActiveSpeakerObserverRequest> EndCreateActiveSpeakerObserverRequest( FlatBufferBuilder builder )
    {
      int o = builder.EndTable();
      builder.Required( o, 4 );  // rtp_observer_id
      builder.Required( o, 6 );  // options
      return new Offset<CreateActiveSpeakerObserverRequest>( o );
    }
    ...
    public static Offset<CreateActiveSpeakerObserverRequest> Pack( FlatBufferBuilder builder, CreateActiveSpeakerObserverRequestT _o )
    {
      if ( _o == null )
        return default( Offset<CreateActiveSpeakerObserverRequest> );
      var _rtp_observer_id = _o.RtpObserverId == null ? default( StringOffset ) : builder.CreateString( _o.RtpObserverId );
      var _options = _o.Options == null ? default( Offset<ActiveSpeakerObserverOptions> ) : ActiveSpeakerObserverOptions.Pack( builder, _o.Options );
  ...
  public class CreateActiveSpeakerObserverRequestT
  {
    ...
    public ActiveSpeakerObserverOptionsT Options { get; set; }
