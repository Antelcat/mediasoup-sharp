...
namespace FlatBuffers.Router
{
  ...
  public Span<byte> GetRtpObserverIdBytes() { return __p.__vector_as_span<byte>(4, 1); }
        ...
        public static Offset<CloseRtpObserverRequest> CreateCloseRtpObserverRequest(FlatBufferBuilder builder,
        ...
        public static Offset<CloseRtpObserverRequest> EndCloseRtpObserverRequest(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // rtp_observer_id
            return new Offset<CloseRtpObserverRequest>(o);
        }
        ...
        public static Offset<CloseRtpObserverRequest> Pack(FlatBufferBuilder builder, CloseRtpObserverRequestT _o)
        {
            if(_o == null)
                return default(Offset<CloseRtpObserverRequest>);
