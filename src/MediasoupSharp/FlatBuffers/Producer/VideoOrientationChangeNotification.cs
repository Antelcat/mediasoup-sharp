...
namespace FlatBuffers.Producer
{
    public struct VideoOrientationChangeNotification : IFlatbufferObject
    {
        ...
        public static Offset<VideoOrientationChangeNotification> CreateVideoOrientationChangeNotification(FlatBufferBuilder builder,
                                                                                                          bool camera = false,
                                                                                                          bool flip = false,
                                                                                                          ushort rotation = 0)
        {
        ...
        public static Offset<VideoOrientationChangeNotification> EndVideoOrientationChangeNotification(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<VideoOrientationChangeNotification>(o);
        }
        ...
        public static Offset<VideoOrientationChangeNotification> Pack(FlatBufferBuilder builder, VideoOrientationChangeNotificationT _o)
        {
            if(_o == null)
                return default(Offset<VideoOrientationChangeNotification>);
