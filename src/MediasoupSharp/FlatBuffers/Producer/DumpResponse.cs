...
namespace FlatBuffers.Producer
{
  ...
  public Span<byte> GetIdBytes() { return __p.__vector_as_span<byte>(4, 1); }
        ...
        public MediaKind Kind { get { int o = __p.__offset(6); return o != 0 ? (MediaKind)__p.bb.Get(o + __p.bb_pos) : MediaKind.audio; } }
        public Type Type { get { int o = __p.__offset(8); return o != 0 ? (Type)__p.bb.Get(o + __p.bb_pos) : Type.SIMPLE; } }
        ...
        public RtpMapping? RtpMapping { get { int o = __p.__offset(12); return o != 0 ? (RtpMapping?)(new RtpMapping()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
        public Dump? RtpStreams(int j) { int o = __p.__offset(14); return o != 0 ? (Dump?)(new Dump()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
        public int RtpStreamsLength { get { int o = __p.__offset(14); return o != 0 ? __p.__vector_len(o) : 0; } }
        public TraceEventType TraceEventTypes(int j) { int o = __p.__offset(16); return o != 0 ? (TraceEventType)__p.bb.Get(__p.__vector(o) + j * 1) : (TraceEventType)0; }
  ...
  public Span<FBS.Producer.TraceEventType> GetTraceEventTypesBytes() { return __p.__vector_as_span<FBS.Producer.TraceEventType>(16, 1); }
...
#endif
        public TraceEventType[] GetTraceEventTypesArray() { int o = __p.__offset(16); if(o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); TraceEventType[] a = new TraceEventType[l]; for(int i = 0; i < l; i++) { a[i] = (TraceEventType)__p.bb.Get(p + i * 1); } return a; }
        ...
        public static Offset<DumpResponse> CreateDumpResponse(FlatBufferBuilder builder,
                                                              ...
                                                              Offset<RtpMapping> rtp_mappingOffset = default(Offset<RtpMapping>),
        ...
        public static void AddKind(FlatBufferBuilder builder, MediaKind kind) { builder.AddByte(1, (byte)kind, 0); }
        ...
        public static void AddRtpMapping(FlatBufferBuilder builder, Offset<RtpMapping> rtpMappingOffset) { builder.AddOffset(4, rtpMappingOffset.Value, 0); }
        ...
        public static VectorOffset CreateRtpStreamsVector(FlatBufferBuilder builder, Offset<Dump>[] data) { builder.StartVector(4, data.Length, 4); for(int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
        public static VectorOffset CreateRtpStreamsVectorBlock(FlatBufferBuilder builder, Offset<Dump>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
        public static VectorOffset CreateRtpStreamsVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<Dump>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
        public static VectorOffset CreateRtpStreamsVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<Dump>>(dataPtr, sizeInBytes); return builder.EndVector(); }
        ...
        public static Offset<DumpResponse> Pack(FlatBufferBuilder builder, DumpResponseT _o)
        {
            ...
            var _rtp_mapping = _o.RtpMapping == null ? default(Offset<RtpMapping>) : FlatBuffers.RtpParameters.RtpMapping.Pack(builder, _o.RtpMapping);
            var _rtp_streams = default(VectorOffset);
            if(_o.RtpStreams != null)
            {
                var __rtp_streams = new Offset<Dump>[_o.RtpStreams.Count];
                for(var _j = 0; _j < __rtp_streams.Length; ++_j)
                { __rtp_streams[_j] = Dump.Pack(builder, _o.RtpStreams[_j]); }
