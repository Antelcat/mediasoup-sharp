...
namespace FlatBuffers.Producer
{
    public struct FirTraceInfo : IFlatbufferObject
    {
        ...
        public static Offset<FirTraceInfo> CreateFirTraceInfo(FlatBufferBuilder builder,
                                                              uint ssrc = 0)
        {
        ...
        public static Offset<FirTraceInfo> EndFirTraceInfo(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<FirTraceInfo>(o);
        }
        ...
        public static Offset<FirTraceInfo> Pack(FlatBufferBuilder builder, FirTraceInfoT _o)
        {
            if(_o == null)
                return default(Offset<FirTraceInfo>);
