...
namespace FlatBuffers.Producer
{
    public struct SrTraceInfo : IFlatbufferObject
    {
        ...
        public static Offset<SrTraceInfo> CreateSrTraceInfo(FlatBufferBuilder builder,
                                                            uint ssrc = 0,
                                                            uint ntp_sec = 0,
                                                            uint ntp_frac = 0,
                                                            uint rtp_ts = 0,
        ...
        public static Offset<SrTraceInfo> EndSrTraceInfo(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<SrTraceInfo>(o);
        }
        ...
        public static Offset<SrTraceInfo> Pack(FlatBufferBuilder builder, SrTraceInfoT _o)
        {
            if(_o == null)
                return default(Offset<SrTraceInfo>);
