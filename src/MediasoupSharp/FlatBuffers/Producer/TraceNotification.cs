...
namespace FlatBuffers.Producer
{
    public struct TraceNotification : IFlatbufferObject
    {
        ...
        public SrTraceInfo InfoAsSrTraceInfo() { return Info<SrTraceInfo>().Value; }
        ...
        public void UnPackTo(TraceNotificationT _o)
        {
            ...
            switch(this.InfoType)
            {
                ...
                case TraceInfo.SrTraceInfo:
                    _o.Info.Value = this.Info<SrTraceInfo>().HasValue ? this.Info<SrTraceInfo>().Value.UnPack() : null;
                    break;
            }
        }
