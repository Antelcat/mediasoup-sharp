...
namespace FlatBuffers.RtpStream
{
    public struct SendStats : IFlatbufferObject
    {
        ...
        public static Offset<SendStats> CreateSendStats(FlatBufferBuilder builder,
        ...
        public static Offset<SendStats> EndSendStats(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // base
            return new Offset<SendStats>(o);
        }
        ...
        public static Offset<SendStats> Pack(FlatBufferBuilder builder, SendStatsT _o)
        {
            if(_o == null)
                return default(Offset<SendStats>);
