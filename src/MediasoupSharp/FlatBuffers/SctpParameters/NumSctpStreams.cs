...
namespace FlatBuffers.SctpParameters
{
    public struct NumSctpStreams : IFlatbufferObject
    {
        ...
        public static Offset<NumSctpStreams> CreateNumSctpStreams(FlatBufferBuilder builder,
                                                                  ushort os = 1024,
                                                                  ushort mis = 1024)
        {
        ...
        public static Offset<NumSctpStreams> EndNumSctpStreams(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<NumSctpStreams>(o);
        }
        ...
        public static Offset<NumSctpStreams> Pack(FlatBufferBuilder builder, NumSctpStreamsT _o)
        {
            if(_o == null)
                return default(Offset<NumSctpStreams>);
