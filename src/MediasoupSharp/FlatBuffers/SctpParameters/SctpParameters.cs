...
namespace FlatBuffers.SctpParameters
{
    public struct SctpParameters : IFlatbufferObject
    {
        ...
        public static Offset<SctpParameters> CreateSctpParameters(FlatBufferBuilder builder,
                                                                  ushort port = 5000,
                                                                  ushort os = 0,
                                                                  ushort mis = 0,
        ...
        public static Offset<SctpParameters> EndSctpParameters(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<SctpParameters>(o);
        }
        ...
        public static Offset<SctpParameters> Pack(FlatBufferBuilder builder, SctpParametersT _o)
        {
            if(_o == null)
                return default(Offset<SctpParameters>);
