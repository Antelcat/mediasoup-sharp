...
namespace FlatBuffers.SctpParameters
{
    public struct SctpStreamParameters : IFlatbufferObject
    {
        ...
        public static Offset<SctpStreamParameters> CreateSctpStreamParameters(FlatBufferBuilder builder,
                                                                              ushort stream_id = 0,
                                                                              bool? ordered = null,
        ...
        public static Offset<SctpStreamParameters> EndSctpStreamParameters(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<SctpStreamParameters>(o);
        }
        ...
        public static Offset<SctpStreamParameters> Pack(FlatBufferBuilder builder, SctpStreamParametersT _o)
        {
            if(_o == null)
                return default(Offset<SctpStreamParameters>);
