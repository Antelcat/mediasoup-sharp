...
namespace FlatBuffers.WebRtcServer
{
  ...
  public Span<byte> GetWebRtcTransportIdBytes() { return __p.__vector_as_span<byte>(6, 1); }
        ...
        public static Offset<IceUserNameFragment> CreateIceUserNameFragment(FlatBufferBuilder builder,
        ...
        public static Offset<IceUserNameFragment> EndIceUserNameFragment(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // local_ice_username_fragment
            builder.Required(o, 6);  // web_rtc_transport_id
            return new Offset<IceUserNameFragment>(o);
        }
        ...
        public static Offset<IceUserNameFragment> Pack(FlatBufferBuilder builder, IceUserNameFragmentT _o)
        {
            if(_o == null)
                return default(Offset<IceUserNameFragment>);
