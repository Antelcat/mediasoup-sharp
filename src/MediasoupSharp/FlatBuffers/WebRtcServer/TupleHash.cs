...
namespace FlatBuffers.WebRtcServer
{
  ...
  public Span<byte> GetWebRtcTransportIdBytes() { return __p.__vector_as_span<byte>(6, 1); }
        ...
        public static Offset<TupleHash> CreateTupleHash(FlatBufferBuilder builder,
                                                        ulong tuple_hash = 0,
        ...
        public static Offset<TupleHash> EndTupleHash(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 6);  // web_rtc_transport_id
            return new Offset<TupleHash>(o);
        }
        ...
        public static Offset<TupleHash> Pack(FlatBufferBuilder builder, TupleHashT _o)
        {
            if(_o == null)
                return default(Offset<TupleHash>);
