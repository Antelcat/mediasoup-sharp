...
namespace FlatBuffers.WebRtcServer
{
  ...
  public Span<byte> GetIpBytes() { return __p.__vector_as_span<byte>(4, 1); }
        ...
        public static Offset<IpPort> CreateIpPort(FlatBufferBuilder builder,
        ...
        public static Offset<IpPort> EndIpPort(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // ip
            return new Offset<IpPort>(o);
        }
        ...
        public static Offset<IpPort> Pack(FlatBufferBuilder builder, IpPortT _o)
        {
            if(_o == null)
                return default(Offset<IpPort>);
