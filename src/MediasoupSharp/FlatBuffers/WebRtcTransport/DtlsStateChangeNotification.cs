...
namespace FlatBuffers.WebRtcTransport
{
    public struct DtlsStateChangeNotification : IFlatbufferObject
    {
        ...
        public DtlsState DtlsState { get { int o = __p.__offset(4); return o != 0 ? (DtlsState)__p.bb.Get(o + __p.bb_pos) : DtlsState.NEW; } }
  ...
  public Span<byte> GetRemoteCertBytes() { return __p.__vector_as_span<byte>(6, 1); }
        ...
        public static Offset<DtlsStateChangeNotification> CreateDtlsStateChangeNotification(FlatBufferBuilder builder,
        ...
        public static void AddDtlsState(FlatBufferBuilder builder, DtlsState dtlsState) { builder.AddByte(0, (byte)dtlsState, 0); }
        ...
        public static Offset<DtlsStateChangeNotification> EndDtlsStateChangeNotification(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<DtlsStateChangeNotification>(o);
        }
        ...
        public static Offset<DtlsStateChangeNotification> Pack(FlatBufferBuilder builder, DtlsStateChangeNotificationT _o)
        {
            if(_o == null)
                return default(Offset<DtlsStateChangeNotification>);
