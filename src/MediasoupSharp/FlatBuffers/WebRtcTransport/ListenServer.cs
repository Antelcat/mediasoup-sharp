...
namespace FlatBuffers.WebRtcTransport
{
  ...
  public Span<byte> GetWebRtcServerIdBytes() { return __p.__vector_as_span<byte>(4, 1); }
        ...
        public static Offset<ListenServer> CreateListenServer(FlatBufferBuilder builder,
        ...
        public static Offset<ListenServer> EndListenServer(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // web_rtc_server_id
            return new Offset<ListenServer>(o);
        }
        ...
        public static Offset<ListenServer> Pack(FlatBufferBuilder builder, ListenServerT _o)
        {
            if(_o == null)
                return default(Offset<ListenServer>);
