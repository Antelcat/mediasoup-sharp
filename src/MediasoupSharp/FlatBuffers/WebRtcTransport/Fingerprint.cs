...
namespace FlatBuffers.WebRtcTransport
{
    public struct Fingerprint : IFlatbufferObject
    {
        ...
        public FingerprintAlgorithm Algorithm { get { int o = __p.__offset(4); return o != 0 ? (FingerprintAlgorithm)__p.bb.Get(o + __p.bb_pos) : FingerprintAlgorithm.SHA1; } }
  ...
  public Span<byte> GetValueBytes() { return __p.__vector_as_span<byte>(6, 1); }
        ...
        public static Offset<Fingerprint> CreateFingerprint(FlatBufferBuilder builder,
                                                            FingerprintAlgorithm algorithm = FingerprintAlgorithm.SHA1,
        ...
        public static void AddAlgorithm(FlatBufferBuilder builder, FingerprintAlgorithm algorithm) { builder.AddByte(0, (byte)algorithm, 0); }
        public static void AddValue(FlatBufferBuilder builder, StringOffset valueOffset) { builder.AddOffset(1, valueOffset.Value, 0); }
        public static Offset<Fingerprint> EndFingerprint(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 6);  // value
            return new Offset<Fingerprint>(o);
        }
        ...
        public static Offset<Fingerprint> Pack(FlatBufferBuilder builder, FingerprintT _o)
        {
            if(_o == null)
                return default(Offset<Fingerprint>);
