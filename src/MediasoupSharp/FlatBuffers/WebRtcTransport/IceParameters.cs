...
namespace FlatBuffers.WebRtcTransport
{
  ...
  public Span<byte> GetPasswordBytes() { return __p.__vector_as_span<byte>(6, 1); }
        ...
        public static Offset<IceParameters> CreateIceParameters(FlatBufferBuilder builder,
        ...
        public static Offset<IceParameters> EndIceParameters(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // username_fragment
            builder.Required(o, 6);  // password
            return new Offset<IceParameters>(o);
        }
        ...
        public static Offset<IceParameters> Pack(FlatBufferBuilder builder, IceParametersT _o)
        {
            if(_o == null)
                return default(Offset<IceParameters>);
