...
namespace FlatBuffers.WebRtcTransport
{
    public struct ListenIndividual : IFlatbufferObject
    {
        ...
        public ListenInfo? ListenInfos(int j) { int o = __p.__offset(4); return o != 0 ? (ListenInfo?)(new ListenInfo()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
        public int ListenInfosLength { get { int o = __p.__offset(4); return o != 0 ? __p.__vector_len(o) : 0; } }

        public static Offset<ListenIndividual> CreateListenIndividual(FlatBufferBuilder builder,
        ...
        public static Offset<ListenIndividual> EndListenIndividual(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // listen_infos
            return new Offset<ListenIndividual>(o);
        }
        ...
        public static Offset<ListenIndividual> Pack(FlatBufferBuilder builder, ListenIndividualT _o)
        {
            if(_o == null)
                return default(Offset<ListenIndividual>);
