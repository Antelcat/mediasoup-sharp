...
namespace FlatBuffers.Consumer
{
    public struct SetPriorityResponse : IFlatbufferObject
    {
        ...
        public static Offset<SetPriorityResponse> CreateSetPriorityResponse(FlatBufferBuilder builder,
                                                                            byte priority = 0)
        {
        ...
        public static Offset<SetPriorityResponse> EndSetPriorityResponse(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<SetPriorityResponse>(o);
        }
        ...
        public static Offset<SetPriorityResponse> Pack(FlatBufferBuilder builder, SetPriorityResponseT _o)
        {
            if(_o == null)
                return default(Offset<SetPriorityResponse>);
