...
namespace FlatBuffers.Consumer
{
    public struct ConsumerLayers : IFlatbufferObject
    {
        ...
        public static Offset<ConsumerLayers> CreateConsumerLayers(FlatBufferBuilder builder,
        ...
        public static Offset<ConsumerLayers> EndConsumerLayers(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<ConsumerLayers>(o);
        }
        ...
        public static Offset<ConsumerLayers> Pack(FlatBufferBuilder builder, ConsumerLayersT _o)
        {
            if(_o == null)
                return default(Offset<ConsumerLayers>);
