...
namespace FlatBuffers.Consumer
{
    public struct RtpTraceInfo : IFlatbufferObject
    {
        ...
        public static Offset<RtpTraceInfo> CreateRtpTraceInfo(FlatBufferBuilder builder,
        ...
        public static Offset<RtpTraceInfo> EndRtpTraceInfo(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // rtp_packet
            return new Offset<RtpTraceInfo>(o);
        }
        ...
        public static Offset<RtpTraceInfo> Pack(FlatBufferBuilder builder, RtpTraceInfoT _o)
        {
            if(_o == null)
                return default(Offset<RtpTraceInfo>);
