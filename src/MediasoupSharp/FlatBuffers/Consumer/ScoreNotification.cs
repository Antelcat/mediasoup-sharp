...
namespace FlatBuffers.Consumer
{
    public struct ScoreNotification : IFlatbufferObject
    {
        ...
        public ConsumerScore? Score { get { int o = __p.__offset(4); return o != 0 ? (ConsumerScore?)(new ConsumerScore()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
        ...
        public static void AddScore(FlatBufferBuilder builder, Offset<ConsumerScore> scoreOffset) { builder.AddOffset(0, scoreOffset.Value, 0); }
