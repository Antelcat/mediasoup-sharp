...
namespace FlatBuffers.Consumer
{
    public struct ConsumerDump : IFlatbufferObject
    {
        ...
        public BaseConsumerDump? Base { get { int o = __p.__offset(4); return o != 0 ? (BaseConsumerDump?)(new BaseConsumerDump()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
        public Dump? RtpStreams(int j) { int o = __p.__offset(6); return o != 0 ? (Dump?)(new Dump()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
        ...
        public static Offset<ConsumerDump> CreateConsumerDump(FlatBufferBuilder builder,
                                                              Offset<BaseConsumerDump> @baseOffset = default(Offset<BaseConsumerDump>),
        ...
        public static void AddBase(FlatBufferBuilder builder, Offset<BaseConsumerDump> baseOffset) { builder.AddOffset(0, baseOffset.Value, 0); }
        ...
        public static Offset<ConsumerDump> EndConsumerDump(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // base
            builder.Required(o, 6);  // rtp_streams
            return new Offset<ConsumerDump>(o);
        }
        ...
        public static Offset<ConsumerDump> Pack(FlatBufferBuilder builder, ConsumerDumpT _o)
        {
            if(_o == null)
                return default(Offset<ConsumerDump>);
            var _base = _o.Base == null ? default(Offset<BaseConsumerDump>) : BaseConsumerDump.Pack(builder, _o.Base);
