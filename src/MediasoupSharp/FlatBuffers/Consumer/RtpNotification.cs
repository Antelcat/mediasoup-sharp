...
namespace FlatBuffers.Consumer
{
  ...
  public Span<byte> GetDataBytes() { return __p.__vector_as_span<byte>(4, 1); }
        ...
        public static Offset<RtpNotification> CreateRtpNotification(FlatBufferBuilder builder,
        ...
        public static Offset<RtpNotification> EndRtpNotification(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // data
            return new Offset<RtpNotification>(o);
        }
        ...
        public static Offset<RtpNotification> Pack(FlatBufferBuilder builder, RtpNotificationT _o)
        {
            if(_o == null)
                return default(Offset<RtpNotification>);
