...
namespace FlatBuffers.Consumer
{
  ...
  public Span<byte> GetIdBytes() { return __p.__vector_as_span<byte>(4, 1); }
        ...
        public Type Type { get { int o = __p.__offset(6); return o != 0 ? (Type)__p.bb.Get(o + __p.bb_pos) : Type.SIMPLE; } }
  ...
  public Span<byte> GetProducerIdBytes() { return __p.__vector_as_span<byte>(8, 1); }
        ...
        public MediaKind Kind { get { int o = __p.__offset(10); return o != 0 ? (MediaKind)__p.bb.Get(o + __p.bb_pos) : MediaKind.audio; } }
        public RtpParameters.RtpParameters? RtpParameters { get { int o = __p.__offset(12); return o != 0 ? (RtpParameters.RtpParameters?)(new RtpParameters.RtpParameters()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
  ...
  public Span<byte> GetSupportedCodecPayloadTypesBytes() { return __p.__vector_as_span<byte>(16, 1); }
        ...
        public TraceEventType TraceEventTypes(int j) { int o = __p.__offset(18); return o != 0 ? (TraceEventType)__p.bb.Get(__p.__vector(o) + j * 1) : (TraceEventType)0; }
  ...
  public Span<FBS.Consumer.TraceEventType> GetTraceEventTypesBytes() { return __p.__vector_as_span<FBS.Consumer.TraceEventType>(18, 1); }
...
#endif
        public TraceEventType[] GetTraceEventTypesArray() { int o = __p.__offset(18); if(o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); TraceEventType[] a = new TraceEventType[l]; for(int i = 0; i < l; i++) { a[i] = (TraceEventType)__p.bb.Get(p + i * 1); } return a; }
        ...
        public static Offset<BaseConsumerDump> CreateBaseConsumerDump(FlatBufferBuilder builder,
        ...
        public static void AddKind(FlatBufferBuilder builder, MediaKind kind) { builder.AddByte(3, (byte)kind, 0); }
        public static void AddRtpParameters(FlatBufferBuilder builder, Offset<RtpParameters.RtpParameters> rtpParametersOffset) { builder.AddOffset(4, rtpParametersOffset.Value, 0); }
        ...
        public static Offset<BaseConsumerDump> EndBaseConsumerDump(FlatBufferBuilder builder)
        {
            ...
            return new Offset<BaseConsumerDump>(o);
        }
        ...
        public static Offset<BaseConsumerDump> Pack(FlatBufferBuilder builder, BaseConsumerDumpT _o)
        {
            if(_o == null)
                return default(Offset<BaseConsumerDump>);
