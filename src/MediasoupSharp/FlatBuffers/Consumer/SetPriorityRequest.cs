...
namespace FlatBuffers.Consumer
{
    public struct SetPriorityRequest : IFlatbufferObject
    {
        ...
        public static Offset<SetPriorityRequest> CreateSetPriorityRequest(FlatBufferBuilder builder,
                                                                          byte priority = 0)
        {
        ...
        public static Offset<SetPriorityRequest> EndSetPriorityRequest(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<SetPriorityRequest>(o);
        }
        ...
        public static Offset<SetPriorityRequest> Pack(FlatBufferBuilder builder, SetPriorityRequestT _o)
        {
            if(_o == null)
                return default(Offset<SetPriorityRequest>);
