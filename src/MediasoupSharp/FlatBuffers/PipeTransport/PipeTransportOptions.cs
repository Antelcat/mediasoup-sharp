...
namespace FlatBuffers.PipeTransport
{
    public struct PipeTransportOptions : IFlatbufferObject
    {
        ...
        public static Offset<PipeTransportOptions> CreatePipeTransportOptions(FlatBufferBuilder builder,
        ...
        public static Offset<PipeTransportOptions> EndPipeTransportOptions(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // base
            builder.Required(o, 6);  // listen_info
            return new Offset<PipeTransportOptions>(o);
        }
        ...
        public static Offset<PipeTransportOptions> Pack(FlatBufferBuilder builder, PipeTransportOptionsT _o)
        {
            if(_o == null)
                return default(Offset<PipeTransportOptions>);
