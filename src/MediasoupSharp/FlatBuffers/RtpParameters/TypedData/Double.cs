...
namespace FlatBuffers.RtpParameters
{
    public struct Double : IFlatbufferObject
    {
        ...
        public static Offset<Double> CreateDouble(FlatBufferBuilder builder,
                                                  double value = 0.0)
        {
        ...
        public static Offset<Double> EndDouble(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<Double>(o);
        }
        ...
        public static Offset<Double> Pack(FlatBufferBuilder builder, DoubleT _o)
        {
            if(_o == null)
                return default(Offset<Double>);
            return CreateDouble(
              builder,
              _o.Value);
        }
