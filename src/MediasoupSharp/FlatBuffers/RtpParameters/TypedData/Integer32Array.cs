...
namespace FlatBuffers.RtpParameters
{
  ...
  public Span<int> GetValueBytes() { return __p.__vector_as_span<int>(4, 4); }
        ...
        public static Offset<Integer32Array> CreateInteger32Array(FlatBufferBuilder builder,
        ...
        public static Offset<Integer32Array> EndInteger32Array(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<Integer32Array>(o);
        }
        ...
        public static Offset<Integer32Array> Pack(FlatBufferBuilder builder, Integer32ArrayT _o)
        {
            if(_o == null)
                return default(Offset<Integer32Array>);
