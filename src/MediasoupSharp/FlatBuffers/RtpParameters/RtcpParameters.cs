...
namespace FlatBuffers.RtpParameters
{
  ...
  public Span<byte> GetCnameBytes() { return __p.__vector_as_span<byte>(4, 1); }
        ...
        public static Offset<RtcpParameters> CreateRtcpParameters(FlatBufferBuilder builder,
        ...
        public static Offset<RtcpParameters> EndRtcpParameters(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<RtcpParameters>(o);
        }
        ...
        public static Offset<RtcpParameters> Pack(FlatBufferBuilder builder, RtcpParametersT _o)
        {
            if(_o == null)
                return default(Offset<RtcpParameters>);
