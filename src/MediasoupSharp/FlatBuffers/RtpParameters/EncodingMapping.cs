...
namespace FlatBuffers.RtpParameters
{
  ...
  public Span<byte> GetScalabilityModeBytes() { return __p.__vector_as_span<byte>(8, 1); }
        ...
        public static Offset<EncodingMapping> CreateEncodingMapping(FlatBufferBuilder builder,
        ...
        public static Offset<EncodingMapping> EndEncodingMapping(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<EncodingMapping>(o);
        }
        ...
        public static Offset<EncodingMapping> Pack(FlatBufferBuilder builder, EncodingMappingT _o)
        {
            if(_o == null)
                return default(Offset<EncodingMapping>);
