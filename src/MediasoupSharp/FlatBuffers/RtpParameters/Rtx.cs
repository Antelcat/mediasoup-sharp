...
namespace FlatBuffers.RtpParameters
{
    public struct Rtx : IFlatbufferObject
    {
        ...
        public static Offset<Rtx> CreateRtx(FlatBufferBuilder builder,
                                            uint ssrc = 0)
        {
        ...
        public static Offset<Rtx> EndRtx(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<Rtx>(o);
        }
        public RtxT UnPack()
        {
            var _o = new RtxT();
        ...
        public static Offset<Rtx> Pack(FlatBufferBuilder builder, RtxT _o)
        {
            if(_o == null)
                return default(Offset<Rtx>);
            return CreateRtx(
              builder,
              _o.Ssrc);
        }
