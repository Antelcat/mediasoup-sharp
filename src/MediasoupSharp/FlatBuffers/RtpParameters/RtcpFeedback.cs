...
namespace FlatBuffers.RtpParameters
{
  ...
  public Span<byte> GetParameterBytes() { return __p.__vector_as_span<byte>(6, 1); }
        ...
        public static Offset<RtcpFeedback> CreateRtcpFeedback(FlatBufferBuilder builder,
        ...
        public static Offset<RtcpFeedback> EndRtcpFeedback(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // type
            return new Offset<RtcpFeedback>(o);
        }
        ...
        public static Offset<RtcpFeedback> Pack(FlatBufferBuilder builder, RtcpFeedbackT _o)
        {
            if(_o == null)
                return default(Offset<RtcpFeedback>);
