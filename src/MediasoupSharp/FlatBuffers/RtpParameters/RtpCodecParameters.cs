...
namespace FlatBuffers.RtpParameters
{
  ...
  public Span<byte> GetMimeTypeBytes() { return __p.__vector_as_span<byte>(4, 1); }
        ...
        public Parameter? Parameters(int j) { int o = __p.__offset(12); return o != 0 ? (Parameter?)(new Parameter()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
        public int ParametersLength { get { int o = __p.__offset(12); return o != 0 ? __p.__vector_len(o) : 0; } }
        public RtcpFeedback? RtcpFeedback(int j) { int o = __p.__offset(14); return o != 0 ? (RtcpFeedback?)(new RtcpFeedback()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
        public int RtcpFeedbackLength { get { int o = __p.__offset(14); return o != 0 ? __p.__vector_len(o) : 0; } }

        public static Offset<RtpCodecParameters> CreateRtpCodecParameters(FlatBufferBuilder builder,
        ...
        public static VectorOffset CreateRtcpFeedbackVector(FlatBufferBuilder builder, Offset<RtcpFeedback>[] data) { builder.StartVector(4, data.Length, 4); for(int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
        public static VectorOffset CreateRtcpFeedbackVectorBlock(FlatBufferBuilder builder, Offset<RtcpFeedback>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
        public static VectorOffset CreateRtcpFeedbackVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<RtcpFeedback>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
        public static VectorOffset CreateRtcpFeedbackVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<RtcpFeedback>>(dataPtr, sizeInBytes); return builder.EndVector(); }
        public static void StartRtcpFeedbackVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
        public static Offset<RtpCodecParameters> EndRtpCodecParameters(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // mime_type
            return new Offset<RtpCodecParameters>(o);
        }
        ...
        public void UnPackTo(RtpCodecParametersT _o)
        {
            ...
            _o.RtcpFeedback = new List<RtcpFeedbackT>();
        ...
        public static Offset<RtpCodecParameters> Pack(FlatBufferBuilder builder, RtpCodecParametersT _o)
        {
            if(_o == null)
                return default(Offset<RtpCodecParameters>);
            ...
            {
                var __rtcp_feedback = new Offset<RtcpFeedback>[_o.RtcpFeedback.Count];
                for(var _j = 0; _j < __rtcp_feedback.Length; ++_j)
                { __rtcp_feedback[_j] = FlatBuffers.RtpParameters.RtcpFeedback.Pack(builder, _o.RtcpFeedback[_j]); }
