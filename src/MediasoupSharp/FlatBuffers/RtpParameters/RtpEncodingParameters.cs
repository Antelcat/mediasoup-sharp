...
namespace FlatBuffers.RtpParameters
{
  ...
  public Span<byte> GetRidBytes() { return __p.__vector_as_span<byte>(6, 1); }
        ...
        public Rtx? Rtx { get { int o = __p.__offset(10); return o != 0 ? (Rtx?)(new Rtx()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
  ...
  public Span<byte> GetScalabilityModeBytes() { return __p.__vector_as_span<byte>(14, 1); }
        ...
        public static Offset<RtpEncodingParameters> CreateRtpEncodingParameters(FlatBufferBuilder builder,
                                                                                uint? ssrc = null,
                                                                                StringOffset ridOffset = default(StringOffset),
                                                                                byte? codec_payload_type = null,
                                                                                Offset<Rtx> rtxOffset = default(Offset<Rtx>),
                                                                                bool dtx = false,
        ...
        public static void AddRtx(FlatBufferBuilder builder, Offset<Rtx> rtxOffset) { builder.AddOffset(3, rtxOffset.Value, 0); }
        ...
        public static Offset<RtpEncodingParameters> EndRtpEncodingParameters(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<RtpEncodingParameters>(o);
        }
        ...
        public static Offset<RtpEncodingParameters> Pack(FlatBufferBuilder builder, RtpEncodingParametersT _o)
        {
            if(_o == null)
                return default(Offset<RtpEncodingParameters>);
            var _rid = _o.Rid == null ? default(StringOffset) : builder.CreateString(_o.Rid);
            var _rtx = _o.Rtx == null ? default(Offset<Rtx>) : FlatBuffers.RtpParameters.Rtx.Pack(builder, _o.Rtx);
