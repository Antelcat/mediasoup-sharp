...
namespace FlatBuffers.DataProducer
{
  ...
  public Span<ushort> GetSubchannelsBytes() { return __p.__vector_as_span<ushort>(8, 2); }
        ...
        public static Offset<SendNotification> CreateSendNotification(FlatBufferBuilder builder,
                                                                      uint ppid = 0,
        ...
        public static Offset<SendNotification> EndSendNotification(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 6);  // data
            return new Offset<SendNotification>(o);
        }
        ...
        public static Offset<SendNotification> Pack(FlatBufferBuilder builder, SendNotificationT _o)
        {
            if(_o == null)
                return default(Offset<SendNotification>);
