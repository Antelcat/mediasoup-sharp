...
namespace FlatBuffers.AudioLevelObserver
{
  ...
  public Span<byte> GetProducerIdBytes() { return __p.__vector_as_span<byte>(4, 1); }
        ...
        public static Offset<Volume> CreateVolume(FlatBufferBuilder builder,
        ...
        public static Offset<Volume> EndVolume(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // producer_id
            return new Offset<Volume>(o);
        }
        ...
        public static Offset<Volume> Pack(FlatBufferBuilder builder, VolumeT _o)
        {
            if(_o == null)
                return default(Offset<Volume>);
