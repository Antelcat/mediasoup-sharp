...
namespace FlatBuffers.AudioLevelObserver
{
    public struct AudioLevelObserverOptions : IFlatbufferObject
    {
        ...
        public static Offset<AudioLevelObserverOptions> CreateAudioLevelObserverOptions(FlatBufferBuilder builder,
        ...
        public static Offset<AudioLevelObserverOptions> EndAudioLevelObserverOptions(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<AudioLevelObserverOptions>(o);
        }
        ...
        public static Offset<AudioLevelObserverOptions> Pack(FlatBufferBuilder builder, AudioLevelObserverOptionsT _o)
        {
            if(_o == null)
                return default(Offset<AudioLevelObserverOptions>);
