...
namespace FlatBuffers.RtxStream
{
  ...
  public Span<byte> GetCnameBytes() { return __p.__vector_as_span<byte>(14, 1); }
        ...
        public static Offset<Params> CreateParams(FlatBufferBuilder builder,
                                                  uint ssrc = 0,
                                                  byte payload_type = 0,
        ...
        public static Offset<Params> EndParams(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 8);  // mime_type
            builder.Required(o, 14);  // cname
            return new Offset<Params>(o);
        }
        ...
        public static Offset<Params> Pack(FlatBufferBuilder builder, ParamsT _o)
        {
            if(_o == null)
                return default(Offset<Params>);
