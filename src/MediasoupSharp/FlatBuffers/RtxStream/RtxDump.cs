...
namespace FlatBuffers.RtxStream
{
    public struct RtxDump : IFlatbufferObject
    {
        ...
        public static Offset<RtxDump> CreateRtxDump(FlatBufferBuilder builder,
        ...
        public static Offset<RtxDump> EndRtxDump(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // params
            return new Offset<RtxDump>(o);
        }
        ...
        public static Offset<RtxDump> Pack(FlatBufferBuilder builder, RtxDumpT _o)
        {
            if(_o == null)
                return default(Offset<RtxDump>);
            var _params = _o.Params == null ? default(Offset<Params>) : RtxStream.Params.Pack(builder, _o.Params);
