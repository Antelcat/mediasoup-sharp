...
namespace FlatBuffers.RtpObserver
{
  ...
  public Span<byte> GetProducerIdBytes() { return __p.__vector_as_span<byte>(4, 1); }
        ...
        public static Offset<AddProducerRequest> CreateAddProducerRequest(FlatBufferBuilder builder,
        ...
        public static Offset<AddProducerRequest> EndAddProducerRequest(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // producer_id
            return new Offset<AddProducerRequest>(o);
        }
        ...
        public static Offset<AddProducerRequest> Pack(FlatBufferBuilder builder, AddProducerRequestT _o)
        {
            if(_o == null)
                return default(Offset<AddProducerRequest>);
