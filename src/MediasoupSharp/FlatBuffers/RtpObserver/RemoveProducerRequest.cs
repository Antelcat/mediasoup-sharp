...
namespace FlatBuffers.RtpObserver
{
  ...
  public Span<byte> GetProducerIdBytes() { return __p.__vector_as_span<byte>(4, 1); }
        ...
        public static Offset<RemoveProducerRequest> CreateRemoveProducerRequest(FlatBufferBuilder builder,
        ...
        public static Offset<RemoveProducerRequest> EndRemoveProducerRequest(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // producer_id
            return new Offset<RemoveProducerRequest>(o);
        }
        ...
        public static Offset<RemoveProducerRequest> Pack(FlatBufferBuilder builder, RemoveProducerRequestT _o)
        {
            if(_o == null)
                return default(Offset<RemoveProducerRequest>);
