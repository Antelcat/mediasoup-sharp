...
namespace FlatBuffers.DataConsumer
{
  ...
  public Span<ushort> GetSubchannelsBytes() { return __p.__vector_as_span<ushort>(4, 2); }
        ...
        public static Offset<SetSubchannelsRequest> CreateSetSubchannelsRequest(FlatBufferBuilder builder,
        ...
        public static Offset<SetSubchannelsRequest> EndSetSubchannelsRequest(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // subchannels
            return new Offset<SetSubchannelsRequest>(o);
        }
        ...
        public static Offset<SetSubchannelsRequest> Pack(FlatBufferBuilder builder, SetSubchannelsRequestT _o)
        {
            if(_o == null)
                return default(Offset<SetSubchannelsRequest>);
