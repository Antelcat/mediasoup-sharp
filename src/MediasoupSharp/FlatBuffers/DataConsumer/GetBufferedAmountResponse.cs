...
namespace FlatBuffers.DataConsumer
{
    public struct GetBufferedAmountResponse : IFlatbufferObject
    {
        ...
        public static Offset<GetBufferedAmountResponse> CreateGetBufferedAmountResponse(FlatBufferBuilder builder,
        ...
        public static Offset<GetBufferedAmountResponse> EndGetBufferedAmountResponse(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<GetBufferedAmountResponse>(o);
        }
        ...
        public static Offset<GetBufferedAmountResponse> Pack(FlatBufferBuilder builder, GetBufferedAmountResponseT _o)
        {
            if(_o == null)
                return default(Offset<GetBufferedAmountResponse>);
