...
{
    public struct AddSubchannelResponse : IFlatbufferObject
    {
        private Table __p;
        public ByteBuffer ByteBuffer { get { return __p.bb; } }
        public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_23_5_26(); }
        public static AddSubchannelResponse GetRootAsAddSubchannelResponse(ByteBuffer _bb) { return GetRootAsAddSubchannelResponse(_bb, new AddSubchannelResponse()); }
        public static AddSubchannelResponse GetRootAsAddSubchannelResponse(ByteBuffer _bb, AddSubchannelResponse obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
        public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
        public AddSubchannelResponse __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public Span<ushort> GetSubchannelsBytes() { return __p.__vector_as_span<ushort>(4, 2); }
        ...
        public static Offset<AddSubchannelResponse> CreateAddSubchannelResponse(FlatBufferBuilder builder,
        ...
        public static void StartAddSubchannelResponse(FlatBufferBuilder builder) { builder.StartTable(1); }
        ...
        public static Offset<AddSubchannelResponse> EndAddSubchannelResponse(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // subchannels
            return new Offset<AddSubchannelResponse>(o);
        }
        public AddSubchannelResponseT UnPack()
        {
            var _o = new AddSubchannelResponseT();
            this.UnPackTo(_o);
            return _o;
        }
        public void UnPackTo(AddSubchannelResponseT _o)
        {
            _o.Subchannels = new List<ushort>();
            for(var _j = 0; _j < this.SubchannelsLength; ++_j)
            { _o.Subchannels.Add(this.Subchannels(_j)); }
        }
        public static Offset<AddSubchannelResponse> Pack(FlatBufferBuilder builder, AddSubchannelResponseT _o)
        {
            if(_o == null)
                return default(Offset<AddSubchannelResponse>);
            ...
            return CreateAddSubchannelResponse(
              builder,
              _subchannels);
        }
    }
