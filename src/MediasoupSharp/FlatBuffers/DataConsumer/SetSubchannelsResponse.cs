...
namespace FlatBuffers.DataConsumer
{
  ...
  public Span<ushort> GetSubchannelsBytes() { return __p.__vector_as_span<ushort>(4, 2); }
        ...
        public static Offset<SetSubchannelsResponse> CreateSetSubchannelsResponse(FlatBufferBuilder builder,
        ...
        public static Offset<SetSubchannelsResponse> EndSetSubchannelsResponse(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // subchannels
            return new Offset<SetSubchannelsResponse>(o);
        }
        ...
        public static Offset<SetSubchannelsResponse> Pack(FlatBufferBuilder builder, SetSubchannelsResponseT _o)
        {
            if(_o == null)
                return default(Offset<SetSubchannelsResponse>);
