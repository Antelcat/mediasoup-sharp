...
namespace FlatBuffers.DataConsumer
{
    public struct AddSubchannelRequest : IFlatbufferObject
    {
        ...
        public static Offset<AddSubchannelRequest> CreateAddSubchannelRequest(FlatBufferBuilder builder,
                                                                              ushort subchannel = 0)
        {
        ...
        public static Offset<AddSubchannelRequest> EndAddSubchannelRequest(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<AddSubchannelRequest>(o);
        }
        ...
        public static Offset<AddSubchannelRequest> Pack(FlatBufferBuilder builder, AddSubchannelRequestT _o)
        {
            if(_o == null)
                return default(Offset<AddSubchannelRequest>);
