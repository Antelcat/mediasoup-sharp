...
namespace FlatBuffers.DataConsumer
{
  ...
  public Span<byte> GetDataBytes() { return __p.__vector_as_span<byte>(6, 1); }
        ...
        public static Offset<MessageNotification> CreateMessageNotification(FlatBufferBuilder builder,
                                                                            uint ppid = 0,
        ...
        public static Offset<MessageNotification> EndMessageNotification(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 6);  // data
            return new Offset<MessageNotification>(o);
        }
        ...
        public static Offset<MessageNotification> Pack(FlatBufferBuilder builder, MessageNotificationT _o)
        {
            if(_o == null)
                return default(Offset<MessageNotification>);
