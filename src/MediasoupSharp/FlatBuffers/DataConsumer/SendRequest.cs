...
namespace FlatBuffers.DataConsumer
{
  ...
  public Span<byte> GetDataBytes() { return __p.__vector_as_span<byte>(6, 1); }
        ...
        public static Offset<SendRequest> CreateSendRequest(FlatBufferBuilder builder,
                                                            uint ppid = 0,
        ...
        public static Offset<SendRequest> EndSendRequest(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 6);  // data
            return new Offset<SendRequest>(o);
        }
        ...
        public static Offset<SendRequest> Pack(FlatBufferBuilder builder, SendRequestT _o)
        {
            if(_o == null)
                return default(Offset<SendRequest>);
