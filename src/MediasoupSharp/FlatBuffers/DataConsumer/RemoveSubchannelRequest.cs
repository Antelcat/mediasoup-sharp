...
namespace FlatBuffers.DataConsumer
{
    public struct RemoveSubchannelRequest : IFlatbufferObject
    {
        ...
        public static Offset<RemoveSubchannelRequest> CreateRemoveSubchannelRequest(FlatBufferBuilder builder,
                                                                                    ushort subchannel = 0)
        {
        ...
        public static Offset<RemoveSubchannelRequest> EndRemoveSubchannelRequest(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<RemoveSubchannelRequest>(o);
        }
        ...
        public static Offset<RemoveSubchannelRequest> Pack(FlatBufferBuilder builder, RemoveSubchannelRequestT _o)
        {
            if(_o == null)
                return default(Offset<RemoveSubchannelRequest>);
