...
namespace FlatBuffers.DataConsumer
{
    public struct SetBufferedAmountLowThresholdRequest : IFlatbufferObject
    {
        ...
        public static Offset<SetBufferedAmountLowThresholdRequest> CreateSetBufferedAmountLowThresholdRequest(FlatBufferBuilder builder,
                                                                                                              uint threshold = 0)
        {
        ...
        public static Offset<SetBufferedAmountLowThresholdRequest> EndSetBufferedAmountLowThresholdRequest(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<SetBufferedAmountLowThresholdRequest>(o);
        }
        ...
        public static Offset<SetBufferedAmountLowThresholdRequest> Pack(FlatBufferBuilder builder, SetBufferedAmountLowThresholdRequestT _o)
        {
            if(_o == null)
                return default(Offset<SetBufferedAmountLowThresholdRequest>);
