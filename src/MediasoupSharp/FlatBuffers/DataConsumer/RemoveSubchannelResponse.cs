...
namespace FlatBuffers.DataConsumer
{
  ...
  public Span<ushort> GetSubchannelsBytes() { return __p.__vector_as_span<ushort>(4, 2); }
        ...
        public static Offset<RemoveSubchannelResponse> CreateRemoveSubchannelResponse(FlatBufferBuilder builder,
        ...
        public static Offset<RemoveSubchannelResponse> EndRemoveSubchannelResponse(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // subchannels
            return new Offset<RemoveSubchannelResponse>(o);
        }
        ...
        public static Offset<RemoveSubchannelResponse> Pack(FlatBufferBuilder builder, RemoveSubchannelResponseT _o)
        {
            if(_o == null)
                return default(Offset<RemoveSubchannelResponse>);
