...
namespace FlatBuffers.DataConsumer
{
    public struct BufferedAmountLowNotification : IFlatbufferObject
    {
        ...
        public static Offset<BufferedAmountLowNotification> CreateBufferedAmountLowNotification(FlatBufferBuilder builder,
        ...
        public static Offset<BufferedAmountLowNotification> EndBufferedAmountLowNotification(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<BufferedAmountLowNotification>(o);
        }
        ...
        public static Offset<BufferedAmountLowNotification> Pack(FlatBufferBuilder builder, BufferedAmountLowNotificationT _o)
        {
            if(_o == null)
                return default(Offset<BufferedAmountLowNotification>);
