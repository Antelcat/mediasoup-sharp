...
namespace FlatBuffers.Transport
{
    public struct SctpListener : IFlatbufferObject
    {
        ...
        public Uint16String? StreamIdTable(int j) { int o = __p.__offset(4); return o != 0 ? (Uint16String?)(new Uint16String()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
        public int StreamIdTableLength { get { int o = __p.__offset(4); return o != 0 ? __p.__vector_len(o) : 0; } }

        public static Offset<SctpListener> CreateSctpListener(FlatBufferBuilder builder,
        ...
        public static VectorOffset CreateStreamIdTableVector(FlatBufferBuilder builder, Offset<Uint16String>[] data) { builder.StartVector(4, data.Length, 4); for(int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
        public static VectorOffset CreateStreamIdTableVectorBlock(FlatBufferBuilder builder, Offset<Uint16String>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
        public static VectorOffset CreateStreamIdTableVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<Uint16String>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
        public static VectorOffset CreateStreamIdTableVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<Uint16String>>(dataPtr, sizeInBytes); return builder.EndVector(); }
        public static void StartStreamIdTableVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
        public static Offset<SctpListener> EndSctpListener(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // stream_id_table
            return new Offset<SctpListener>(o);
        }
        ...
        {
            _o.StreamIdTable = new List<Uint16StringT>();
        ...
        public static Offset<SctpListener> Pack(FlatBufferBuilder builder, SctpListenerT _o)
        {
            if(_o == null)
                return default(Offset<SctpListener>);
            var _stream_id_table = default(VectorOffset);
            if(_o.StreamIdTable != null)
            {
                var __stream_id_table = new Offset<Uint16String>[_o.StreamIdTable.Count];
                for(var _j = 0; _j < __stream_id_table.Length; ++_j)
                { __stream_id_table[_j] = Uint16String.Pack(builder, _o.StreamIdTable[_j]); }
    ...
    public class SctpListenerT
    {
        ...
        public List<Uint16StringT> StreamIdTable { get; set; }
