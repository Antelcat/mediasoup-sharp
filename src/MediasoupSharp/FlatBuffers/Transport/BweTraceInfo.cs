...
namespace FlatBuffers.Transport
{
    public struct BweTraceInfo : IFlatbufferObject
    {
        ...
        public BweType BweType { get { int o = __p.__offset(4); return o != 0 ? (BweType)__p.bb.Get(o + __p.bb_pos) : BweType.TRANSPORT_CC; } }
        ...
        public static Offset<BweTraceInfo> CreateBweTraceInfo(FlatBufferBuilder builder,
                                                              BweType bwe_type = BweType.TRANSPORT_CC,
        ...
        public static void AddBweType(FlatBufferBuilder builder, BweType bweType) { builder.AddByte(0, (byte)bweType, 0); }
        ...
        public static Offset<BweTraceInfo> EndBweTraceInfo(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<BweTraceInfo>(o);
        }
        ...
        public static Offset<BweTraceInfo> Pack(FlatBufferBuilder builder, BweTraceInfoT _o)
        {
            if(_o == null)
                return default(Offset<BweTraceInfo>);
    ...
    public class BweTraceInfoT
    {
        ...
        public BweType BweType { get; set; }
        ...
        {
            this.BweType = BweType.TRANSPORT_CC;
