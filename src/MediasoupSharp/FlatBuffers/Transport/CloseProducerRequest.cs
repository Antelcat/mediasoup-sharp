...
namespace FlatBuffers.Transport
{
  ...
  public Span<byte> GetProducerIdBytes() { return __p.__vector_as_span<byte>(4, 1); }
        ...
        public static Offset<CloseProducerRequest> CreateCloseProducerRequest(FlatBufferBuilder builder,
        ...
        public static Offset<CloseProducerRequest> EndCloseProducerRequest(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // producer_id
            return new Offset<CloseProducerRequest>(o);
        }
        ...
        public static Offset<CloseProducerRequest> Pack(FlatBufferBuilder builder, CloseProducerRequestT _o)
        {
            if(_o == null)
                return default(Offset<CloseProducerRequest>);
