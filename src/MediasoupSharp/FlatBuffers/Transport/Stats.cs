...
namespace FlatBuffers.Transport
{
  ...
  public Span<byte> GetTransportIdBytes() { return __p.__vector_as_span<byte>(4, 1); }
        ...
        public SctpState? SctpState { get { int o = __p.__offset(8); return o != 0 ? (SctpState)__p.bb.Get(o + __p.bb_pos) : (SctpState?)null; } }
        ...
        public static void AddSctpState(FlatBufferBuilder builder, SctpState? sctpState) { builder.AddByte(2, (byte?)sctpState); }
