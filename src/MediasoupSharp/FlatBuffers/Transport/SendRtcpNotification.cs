...
namespace FlatBuffers.Transport
{
  ...
  public Span<byte> GetDataBytes() { return __p.__vector_as_span<byte>(4, 1); }
        ...
        public static Offset<SendRtcpNotification> CreateSendRtcpNotification(FlatBufferBuilder builder,
        ...
        public static Offset<SendRtcpNotification> EndSendRtcpNotification(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // data
            return new Offset<SendRtcpNotification>(o);
        }
        ...
        public static Offset<SendRtcpNotification> Pack(FlatBufferBuilder builder, SendRtcpNotificationT _o)
        {
            if(_o == null)
                return default(Offset<SendRtcpNotification>);
