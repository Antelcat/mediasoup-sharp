...
namespace FlatBuffers.Transport
{
  ...
  public Span<byte> GetIdBytes() { return __p.__vector_as_span<byte>(4, 1); }
        ...
        public Uint32String? MapSsrcConsumerId(int j) { int o = __p.__offset(12); return o != 0 ? (Uint32String?)(new Uint32String()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
        public int MapSsrcConsumerIdLength { get { int o = __p.__offset(12); return o != 0 ? __p.__vector_len(o) : 0; } }
        public Uint32String? MapRtxSsrcConsumerId(int j) { int o = __p.__offset(14); return o != 0 ? (Uint32String?)(new Uint32String()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
        ...
        public RecvRtpHeaderExtensions? RecvRtpHeaderExtensions { get { int o = __p.__offset(20); return o != 0 ? (RecvRtpHeaderExtensions?)(new RecvRtpHeaderExtensions()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
        public RtpListener? RtpListener { get { int o = __p.__offset(22); return o != 0 ? (RtpListener?)(new RtpListener()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
        public uint MaxMessageSize { get { int o = __p.__offset(24); return o != 0 ? __p.bb.GetUint(o + __p.bb_pos) : (uint)0; } }
        public SctpParameters.SctpParameters? SctpParameters { get { int o = __p.__offset(26); return o != 0 ? (SctpParameters.SctpParameters?)(new SctpParameters.SctpParameters()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
        public SctpState? SctpState { get { int o = __p.__offset(28); return o != 0 ? (SctpState)__p.bb.Get(o + __p.bb_pos) : (SctpState?)null; } }
        public SctpListener? SctpListener { get { int o = __p.__offset(30); return o != 0 ? (SctpListener?)(new SctpListener()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
        public TraceEventType TraceEventTypes(int j) { int o = __p.__offset(32); return o != 0 ? (TraceEventType)__p.bb.Get(__p.__vector(o) + j * 1) : (TraceEventType)0; }
  ...
  public Span<FBS.Transport.TraceEventType> GetTraceEventTypesBytes() { return __p.__vector_as_span<FBS.Transport.TraceEventType>(32, 1); }
...
#endif
        public TraceEventType[] GetTraceEventTypesArray() { int o = __p.__offset(32); if(o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); TraceEventType[] a = new TraceEventType[l]; for(int i = 0; i < l; i++) { a[i] = (TraceEventType)__p.bb.Get(p + i * 1); } return a; }
        ...
        public static Offset<Dump> CreateDump(FlatBufferBuilder builder,
                                              ...
                                              Offset<RecvRtpHeaderExtensions> recv_rtp_header_extensionsOffset = default(Offset<RecvRtpHeaderExtensions>),
                                              Offset<RtpListener> rtp_listenerOffset = default(Offset<RtpListener>),
                                              uint max_message_size = 0,
                                              Offset<SctpParameters.SctpParameters> sctp_parametersOffset = default(Offset<SctpParameters.SctpParameters>),
                                              SctpState? sctp_state = null,
                                              Offset<SctpListener> sctp_listenerOffset = default(Offset<SctpListener>),
        ...
        public static VectorOffset CreateMapSsrcConsumerIdVector(FlatBufferBuilder builder, Offset<Uint32String>[] data) { builder.StartVector(4, data.Length, 4); for(int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
        public static VectorOffset CreateMapSsrcConsumerIdVectorBlock(FlatBufferBuilder builder, Offset<Uint32String>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
        public static VectorOffset CreateMapSsrcConsumerIdVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<Uint32String>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
        public static VectorOffset CreateMapSsrcConsumerIdVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<Uint32String>>(dataPtr, sizeInBytes); return builder.EndVector(); }
        ...
        public static VectorOffset CreateMapRtxSsrcConsumerIdVector(FlatBufferBuilder builder, Offset<Uint32String>[] data) { builder.StartVector(4, data.Length, 4); for(int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
        public static VectorOffset CreateMapRtxSsrcConsumerIdVectorBlock(FlatBufferBuilder builder, Offset<Uint32String>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
        public static VectorOffset CreateMapRtxSsrcConsumerIdVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<Uint32String>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
        public static VectorOffset CreateMapRtxSsrcConsumerIdVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<Uint32String>>(dataPtr, sizeInBytes); return builder.EndVector(); }
        ...
        public static void AddRecvRtpHeaderExtensions(FlatBufferBuilder builder, Offset<RecvRtpHeaderExtensions> recvRtpHeaderExtensionsOffset) { builder.AddOffset(8, recvRtpHeaderExtensionsOffset.Value, 0); }
        public static void AddRtpListener(FlatBufferBuilder builder, Offset<RtpListener> rtpListenerOffset) { builder.AddOffset(9, rtpListenerOffset.Value, 0); }
        public static void AddMaxMessageSize(FlatBufferBuilder builder, uint maxMessageSize) { builder.AddUint(10, maxMessageSize, 0); }
        public static void AddSctpParameters(FlatBufferBuilder builder, Offset<SctpParameters.SctpParameters> sctpParametersOffset) { builder.AddOffset(11, sctpParametersOffset.Value, 0); }
        public static void AddSctpState(FlatBufferBuilder builder, SctpState? sctpState) { builder.AddByte(12, (byte?)sctpState); }
        public static void AddSctpListener(FlatBufferBuilder builder, Offset<SctpListener> sctpListenerOffset) { builder.AddOffset(13, sctpListenerOffset.Value, 0); }
        ...
        public static VectorOffset CreateTraceEventTypesVector(FlatBufferBuilder builder, TraceEventType[] data) { builder.StartVector(1, data.Length, 1); for(int i = data.Length - 1; i >= 0; i--) builder.AddByte((byte)data[i]); return builder.EndVector(); }
        public static VectorOffset CreateTraceEventTypesVectorBlock(FlatBufferBuilder builder, TraceEventType[] data) { builder.StartVector(1, data.Length, 1); builder.Add(data); return builder.EndVector(); }
        public static VectorOffset CreateTraceEventTypesVectorBlock(FlatBufferBuilder builder, ArraySegment<TraceEventType> data) { builder.StartVector(1, data.Count, 1); builder.Add(data); return builder.EndVector(); }
        public static VectorOffset CreateTraceEventTypesVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<TraceEventType>(dataPtr, sizeInBytes); return builder.EndVector(); }
        ...
        public void UnPackTo(DumpT _o)
        {
            ...
            _o.MapSsrcConsumerId = new List<Uint32StringT>();
            ...
            _o.MapRtxSsrcConsumerId = new List<Uint32StringT>();
            ...
            _o.TraceEventTypes = new List<TraceEventType>();
        ...
        public static Offset<Dump> Pack(FlatBufferBuilder builder, DumpT _o)
        {
            ...
            {
                var __map_ssrc_consumer_id = new Offset<Uint32String>[_o.MapSsrcConsumerId.Count];
                for(var _j = 0; _j < __map_ssrc_consumer_id.Length; ++_j)
                { __map_ssrc_consumer_id[_j] = Uint32String.Pack(builder, _o.MapSsrcConsumerId[_j]); }
            ...
            {
                var __map_rtx_ssrc_consumer_id = new Offset<Uint32String>[_o.MapRtxSsrcConsumerId.Count];
                for(var _j = 0; _j < __map_rtx_ssrc_consumer_id.Length; ++_j)
                { __map_rtx_ssrc_consumer_id[_j] = Uint32String.Pack(builder, _o.MapRtxSsrcConsumerId[_j]); }
            ...
            var _recv_rtp_header_extensions = _o.RecvRtpHeaderExtensions == null ? default(Offset<RecvRtpHeaderExtensions>) : Transport.RecvRtpHeaderExtensions.Pack(builder, _o.RecvRtpHeaderExtensions);
            var _rtp_listener = _o.RtpListener == null ? default(Offset<RtpListener>) : Transport.RtpListener.Pack(builder, _o.RtpListener);
            var _sctp_parameters = _o.SctpParameters == null ? default(Offset<SctpParameters.SctpParameters>) : FlatBuffers.SctpParameters.SctpParameters.Pack(builder, _o.SctpParameters);
            var _sctp_listener = _o.SctpListener == null ? default(Offset<SctpListener>) : Transport.SctpListener.Pack(builder, _o.SctpListener);
    ...
    public class DumpT
    {
        ...
        [JsonPropertyName("map_ssrc_consumer_id")]
        public List<Uint32StringT> MapSsrcConsumerId { get; set; }
        [JsonPropertyName("map_rtx_ssrc_consumer_id")]
        public List<Uint32StringT> MapRtxSsrcConsumerId { get; set; }
        [JsonPropertyName("data_producer_ids")]
        public List<string> DataProducerIds { get; set; }
        [JsonPropertyName("data_consumer_ids")]
        public List<string> DataConsumerIds { get; set; }
        [JsonPropertyName("recv_rtp_header_extensions")]
        public RecvRtpHeaderExtensionsT RecvRtpHeaderExtensions { get; set; }
        [JsonPropertyName("rtp_listener")]
        public RtpListenerT RtpListener { get; set; }
        [JsonPropertyName("max_message_size")]
        public uint MaxMessageSize { get; set; }
        [JsonPropertyName("sctp_parameters")]
        public SctpParametersT SctpParameters { get; set; }
        [JsonPropertyName("sctp_state")]
        public SctpState? SctpState { get; set; }
        [JsonPropertyName("sctp_listener")]
        public SctpListenerT SctpListener { get; set; }
        [JsonPropertyName("trace_event_types")]
        public List<TraceEventType> TraceEventTypes { get; set; }
