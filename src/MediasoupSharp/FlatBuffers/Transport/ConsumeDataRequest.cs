...
namespace FlatBuffers.Transport
{
  ...
  public Span<ushort> GetSubchannelsBytes() { return __p.__vector_as_span<ushort>(18, 2); }
        ...
        public static Offset<ConsumeDataRequest> CreateConsumeDataRequest(FlatBufferBuilder builder,
        ...
        public static Offset<ConsumeDataRequest> EndConsumeDataRequest(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // data_consumer_id
            builder.Required(o, 6);  // data_producer_id
            return new Offset<ConsumeDataRequest>(o);
        }
        ...
        public static Offset<ConsumeDataRequest> Pack(FlatBufferBuilder builder, ConsumeDataRequestT _o)
        {
            if(_o == null)
                return default(Offset<ConsumeDataRequest>);
