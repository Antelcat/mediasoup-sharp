...
namespace FlatBuffers.Transport
{
  ...
  public Span<byte> GetPasswordBytes() { return __p.__vector_as_span<byte>(6, 1); }
        ...
        public static Offset<RestartIceResponse> CreateRestartIceResponse(FlatBufferBuilder builder,
        ...
        public static Offset<RestartIceResponse> EndRestartIceResponse(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // username_fragment
            builder.Required(o, 6);  // password
            return new Offset<RestartIceResponse>(o);
        }
        ...
        public static Offset<RestartIceResponse> Pack(FlatBufferBuilder builder, RestartIceResponseT _o)
        {
            if(_o == null)
                return default(Offset<RestartIceResponse>);
