...
namespace FlatBuffers.Transport
{
    public struct SetMinOutgoingBitrateRequest : IFlatbufferObject
    {
        ...
        public static Offset<SetMinOutgoingBitrateRequest> CreateSetMinOutgoingBitrateRequest(FlatBufferBuilder builder,
        ...
        public static Offset<SetMinOutgoingBitrateRequest> EndSetMinOutgoingBitrateRequest(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<SetMinOutgoingBitrateRequest>(o);
        }
        ...
        public static Offset<SetMinOutgoingBitrateRequest> Pack(FlatBufferBuilder builder, SetMinOutgoingBitrateRequestT _o)
        {
            if(_o == null)
                return default(Offset<SetMinOutgoingBitrateRequest>);
