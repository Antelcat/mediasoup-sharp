...
namespace FlatBuffers.Transport
{
    public struct Options : IFlatbufferObject
    {
        ...
        public NumSctpStreams? NumSctpStreams { get { int o = __p.__offset(12); return o != 0 ? (NumSctpStreams?)(new NumSctpStreams()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
        ...
        public static Offset<Options> CreateOptions(FlatBufferBuilder builder,
                                                    bool direct = false,
                                                    uint? max_message_size = null,
                                                    uint? initial_available_outgoing_bitrate = null,
                                                    bool enable_sctp = false,
                                                    Offset<NumSctpStreams> num_sctp_streamsOffset = default(Offset<NumSctpStreams>),
        ...
        public static void AddNumSctpStreams(FlatBufferBuilder builder, Offset<NumSctpStreams> numSctpStreamsOffset) { builder.AddOffset(4, numSctpStreamsOffset.Value, 0); }
        ...
        public static Offset<Options> Pack(FlatBufferBuilder builder, OptionsT _o)
        {
            if(_o == null)
                return default(Offset<Options>);
            var _num_sctp_streams = _o.NumSctpStreams == null ? default(Offset<NumSctpStreams>) : SctpParameters.NumSctpStreams.Pack(builder, _o.NumSctpStreams);
