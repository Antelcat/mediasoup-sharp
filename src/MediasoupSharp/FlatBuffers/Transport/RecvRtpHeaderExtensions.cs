...
namespace FlatBuffers.Transport
{
    public struct RecvRtpHeaderExtensions : IFlatbufferObject
    {
        ...
        public static Offset<RecvRtpHeaderExtensions> CreateRecvRtpHeaderExtensions(FlatBufferBuilder builder,
                                                                                    byte? mid = null,
                                                                                    byte? rid = null,
                                                                                    byte? rrid = null,
        ...
        public static Offset<RecvRtpHeaderExtensions> EndRecvRtpHeaderExtensions(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<RecvRtpHeaderExtensions>(o);
        }
        ...
        public static Offset<RecvRtpHeaderExtensions> Pack(FlatBufferBuilder builder, RecvRtpHeaderExtensionsT _o)
        {
            if(_o == null)
                return default(Offset<RecvRtpHeaderExtensions>);
