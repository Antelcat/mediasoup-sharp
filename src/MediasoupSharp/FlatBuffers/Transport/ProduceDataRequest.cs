...
namespace FlatBuffers.Transport
{
  ...
  public Span<byte> GetProtocolBytes() { return __p.__vector_as_span<byte>(12, 1); }
        ...
        public static Offset<ProduceDataRequest> CreateProduceDataRequest(FlatBufferBuilder builder,
        ...
        public static Offset<ProduceDataRequest> EndProduceDataRequest(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // data_producer_id
            return new Offset<ProduceDataRequest>(o);
        }
        ...
        public static Offset<ProduceDataRequest> Pack(FlatBufferBuilder builder, ProduceDataRequestT _o)
        {
            if(_o == null)
                return default(Offset<ProduceDataRequest>);
