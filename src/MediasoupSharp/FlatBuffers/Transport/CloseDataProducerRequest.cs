...
namespace FlatBuffers.Transport
{
  ...
  public Span<byte> GetDataProducerIdBytes() { return __p.__vector_as_span<byte>(4, 1); }
        ...
        public static Offset<CloseDataProducerRequest> CreateCloseDataProducerRequest(FlatBufferBuilder builder,
        ...
        public static Offset<CloseDataProducerRequest> EndCloseDataProducerRequest(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // data_producer_id
            return new Offset<CloseDataProducerRequest>(o);
        }
        ...
        public static Offset<CloseDataProducerRequest> Pack(FlatBufferBuilder builder, CloseDataProducerRequestT _o)
        {
            if(_o == null)
                return default(Offset<CloseDataProducerRequest>);
