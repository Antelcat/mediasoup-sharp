...
namespace FlatBuffers.Transport
{
    public struct ListenInfo : IFlatbufferObject
    {
        ...
        public Protocol Protocol { get { int o = __p.__offset(4); return o != 0 ? (Protocol)__p.bb.Get(o + __p.bb_pos) : Protocol.UDP; } }
  ...
  public Span<byte> GetAnnouncedIpBytes() { return __p.__vector_as_span<byte>(8, 1); }
        ...
        public SocketFlags? Flags { get { int o = __p.__offset(12); return o != 0 ? (SocketFlags?)(new SocketFlags()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
        ...
        public static Offset<ListenInfo> CreateListenInfo(FlatBufferBuilder builder,
                                                          Protocol protocol = Protocol.UDP,
                                                          StringOffset ipOffset = default(StringOffset),
                                                          StringOffset announced_ipOffset = default(StringOffset),
                                                          ushort port = 0,
                                                          Offset<SocketFlags> flagsOffset = default(Offset<SocketFlags>),
        ...
        public static void AddProtocol(FlatBufferBuilder builder, Protocol protocol) { builder.AddByte(0, (byte)protocol, 1); }
        ...
        public static void AddFlags(FlatBufferBuilder builder, Offset<SocketFlags> flagsOffset) { builder.AddOffset(4, flagsOffset.Value, 0); }
        ...
        public static Offset<ListenInfo> EndListenInfo(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 6);  // ip
            builder.Required(o, 12);  // flags
            return new Offset<ListenInfo>(o);
        }
        ...
        public static Offset<ListenInfo> Pack(FlatBufferBuilder builder, ListenInfoT _o)
        {
            if(_o == null)
                return default(Offset<ListenInfo>);
            ...
            var _flags = _o.Flags == null ? default(Offset<SocketFlags>) : SocketFlags.Pack(builder, _o.Flags);
