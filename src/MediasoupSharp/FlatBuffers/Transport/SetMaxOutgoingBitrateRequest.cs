...
namespace FlatBuffers.Transport
{
    public struct SetMaxOutgoingBitrateRequest : IFlatbufferObject
    {
        ...
        public static Offset<SetMaxOutgoingBitrateRequest> CreateSetMaxOutgoingBitrateRequest(FlatBufferBuilder builder,
        ...
        public static Offset<SetMaxOutgoingBitrateRequest> EndSetMaxOutgoingBitrateRequest(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<SetMaxOutgoingBitrateRequest>(o);
        }
        ...
        public static Offset<SetMaxOutgoingBitrateRequest> Pack(FlatBufferBuilder builder, SetMaxOutgoingBitrateRequestT _o)
        {
            if(_o == null)
                return default(Offset<SetMaxOutgoingBitrateRequest>);
