...
namespace FlatBuffers.Transport
{
  ...
  public Span<byte> GetDataConsumerIdBytes() { return __p.__vector_as_span<byte>(4, 1); }
        ...
        public static Offset<CloseDataConsumerRequest> CreateCloseDataConsumerRequest(FlatBufferBuilder builder,
        ...
        public static Offset<CloseDataConsumerRequest> EndCloseDataConsumerRequest(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // data_consumer_id
            return new Offset<CloseDataConsumerRequest>(o);
        }
        ...
        public static Offset<CloseDataConsumerRequest> Pack(FlatBufferBuilder builder, CloseDataConsumerRequestT _o)
        {
            if(_o == null)
                return default(Offset<CloseDataConsumerRequest>);
