...
namespace FlatBuffers.Transport
{
    public struct SocketFlags : IFlatbufferObject
    {
        ...
        public static Offset<SocketFlags> CreateSocketFlags(FlatBufferBuilder builder,
        ...
        public static Offset<SocketFlags> EndSocketFlags(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<SocketFlags>(o);
        }
        ...
        public static Offset<SocketFlags> Pack(FlatBufferBuilder builder, SocketFlagsT _o)
        {
            if(_o == null)
                return default(Offset<SocketFlags>);
