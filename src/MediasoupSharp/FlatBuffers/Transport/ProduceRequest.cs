...
namespace FlatBuffers.Transport
{
  ...
  public Span<byte> GetProducerIdBytes() { return __p.__vector_as_span<byte>(4, 1); }
        ...
        public RtpParameters.RtpParameters? RtpParameters { get { int o = __p.__offset(8); return o != 0 ? (RtpParameters.RtpParameters?)(new RtpParameters.RtpParameters()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
        public RtpMapping? RtpMapping { get { int o = __p.__offset(10); return o != 0 ? (RtpMapping?)(new RtpMapping()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
        ...
        public static Offset<ProduceRequest> CreateProduceRequest(FlatBufferBuilder builder,
        ...
        public static void AddRtpParameters(FlatBufferBuilder builder, Offset<RtpParameters.RtpParameters> rtpParametersOffset) { builder.AddOffset(2, rtpParametersOffset.Value, 0); }
        public static void AddRtpMapping(FlatBufferBuilder builder, Offset<RtpMapping> rtpMappingOffset) { builder.AddOffset(3, rtpMappingOffset.Value, 0); }
        ...
        public static Offset<ProduceRequest> EndProduceRequest(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // producer_id
            builder.Required(o, 8);  // rtp_parameters
            builder.Required(o, 10);  // rtp_mapping
            return new Offset<ProduceRequest>(o);
        }
        ...
        public static Offset<ProduceRequest> Pack(FlatBufferBuilder builder, ProduceRequestT _o)
        {
            if(_o == null)
                return default(Offset<ProduceRequest>);
