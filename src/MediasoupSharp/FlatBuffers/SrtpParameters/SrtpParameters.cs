...
namespace FlatBuffers.SrtpParameters
{
    public struct SrtpParameters : IFlatbufferObject
    {
        ...
        public SrtpCryptoSuite CryptoSuite { get { int o = __p.__offset(4); return o != 0 ? (SrtpCryptoSuite)__p.bb.Get(o + __p.bb_pos) : SrtpCryptoSuite.AEAD_AES_256_GCM; } }
  ...
  public Span<byte> GetKeyBase64Bytes() { return __p.__vector_as_span<byte>(6, 1); }
        ...
        public static Offset<SrtpParameters> CreateSrtpParameters(FlatBufferBuilder builder,
                                                                  SrtpCryptoSuite crypto_suite = SrtpCryptoSuite.AEAD_AES_256_GCM,
        ...
        public static void AddCryptoSuite(FlatBufferBuilder builder, SrtpCryptoSuite cryptoSuite) { builder.AddByte(0, (byte)cryptoSuite, 0); }
        ...
        public static Offset<SrtpParameters> EndSrtpParameters(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 6);  // key_base64
            return new Offset<SrtpParameters>(o);
        }
        ...
        public static Offset<SrtpParameters> Pack(FlatBufferBuilder builder, SrtpParametersT _o)
        {
            if(_o == null)
                return default(Offset<SrtpParameters>);
