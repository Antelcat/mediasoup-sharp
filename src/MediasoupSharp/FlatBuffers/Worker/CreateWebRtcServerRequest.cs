...
namespace FlatBuffers.Worker
{
  ...
  public Span<byte> GetWebRtcServerIdBytes() { return __p.__vector_as_span<byte>(4, 1); }
        ...
        public ListenInfo? ListenInfos(int j) { int o = __p.__offset(6); return o != 0 ? (ListenInfo?)(new ListenInfo()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
        public int ListenInfosLength { get { int o = __p.__offset(6); return o != 0 ? __p.__vector_len(o) : 0; } }

        public static Offset<CreateWebRtcServerRequest> CreateCreateWebRtcServerRequest(FlatBufferBuilder builder,
        ...
        public static VectorOffset CreateListenInfosVector(FlatBufferBuilder builder, Offset<ListenInfo>[] data) { builder.StartVector(4, data.Length, 4); for(int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
        public static VectorOffset CreateListenInfosVectorBlock(FlatBufferBuilder builder, Offset<ListenInfo>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
        public static VectorOffset CreateListenInfosVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<ListenInfo>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
        public static VectorOffset CreateListenInfosVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<ListenInfo>>(dataPtr, sizeInBytes); return builder.EndVector(); }
        public static void StartListenInfosVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
        public static Offset<CreateWebRtcServerRequest> EndCreateWebRtcServerRequest(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // web_rtc_server_id
            return new Offset<CreateWebRtcServerRequest>(o);
        }
        ...
        public void UnPackTo(CreateWebRtcServerRequestT _o)
        {
            ...
            _o.ListenInfos = new List<ListenInfoT>();
        ...
        public static Offset<CreateWebRtcServerRequest> Pack(FlatBufferBuilder builder, CreateWebRtcServerRequestT _o)
        {
            if(_o == null)
                return default(Offset<CreateWebRtcServerRequest>);
            ...
            {
                var __listen_infos = new Offset<ListenInfo>[_o.ListenInfos.Count];
                for(var _j = 0; _j < __listen_infos.Length; ++_j)
                { __listen_infos[_j] = ListenInfo.Pack(builder, _o.ListenInfos[_j]); }
