...
namespace FlatBuffers.Worker
{
  ...
  public Span<byte> GetRouterIdBytes() { return __p.__vector_as_span<byte>(4, 1); }
        ...
        public static Offset<CloseRouterRequest> CreateCloseRouterRequest(FlatBufferBuilder builder,
        ...
        public static Offset<CloseRouterRequest> EndCloseRouterRequest(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // router_id
            return new Offset<CloseRouterRequest>(o);
        }
        ...
        public static Offset<CloseRouterRequest> Pack(FlatBufferBuilder builder, CloseRouterRequestT _o)
        {
            if(_o == null)
                return default(Offset<CloseRouterRequest>);
