...
namespace FlatBuffers.Worker
{
    public struct ChannelMessageHandlers : IFlatbufferObject
    {
        ...
        public static Offset<ChannelMessageHandlers> CreateChannelMessageHandlers(FlatBufferBuilder builder,
        ...
        public static Offset<ChannelMessageHandlers> EndChannelMessageHandlers(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // channel_request_handlers
            builder.Required(o, 6);  // channel_notification_handlers
            return new Offset<ChannelMessageHandlers>(o);
        }
        ...
        public static Offset<ChannelMessageHandlers> Pack(FlatBufferBuilder builder, ChannelMessageHandlersT _o)
        {
            if(_o == null)
                return default(Offset<ChannelMessageHandlers>);
