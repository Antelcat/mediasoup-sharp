...
namespace FlatBuffers.Worker
{
    public struct ResourceUsageResponse : IFlatbufferObject
    {
        ...
        public static Offset<ResourceUsageResponse> CreateResourceUsageResponse(FlatBufferBuilder builder,
                                                                                ulong ru_utime = 0,
                                                                                ulong ru_stime = 0,
                                                                                ulong ru_maxrss = 0,
                                                                                ulong ru_ixrss = 0,
        ...
        public static Offset<ResourceUsageResponse> EndResourceUsageResponse(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<ResourceUsageResponse>(o);
        }
        ...
        public static Offset<ResourceUsageResponse> Pack(FlatBufferBuilder builder, ResourceUsageResponseT _o)
        {
            if(_o == null)
                return default(Offset<ResourceUsageResponse>);
