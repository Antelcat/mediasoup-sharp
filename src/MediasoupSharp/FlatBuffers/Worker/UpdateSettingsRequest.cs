...
namespace FlatBuffers.Worker
{
  ...
  public Span<byte> GetLogLevelBytes() { return __p.__vector_as_span<byte>(4, 1); }
        ...
        public static Offset<UpdateSettingsRequest> CreateUpdateSettingsRequest(FlatBufferBuilder builder,
        ...
        public static Offset<UpdateSettingsRequest> EndUpdateSettingsRequest(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            return new Offset<UpdateSettingsRequest>(o);
        }
        ...
        public static Offset<UpdateSettingsRequest> Pack(FlatBufferBuilder builder, UpdateSettingsRequestT _o)
        {
            if(_o == null)
                return default(Offset<UpdateSettingsRequest>);
