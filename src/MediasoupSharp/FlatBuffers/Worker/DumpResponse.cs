...
namespace FlatBuffers.Worker
{
    public struct DumpResponse : IFlatbufferObject
    {
        ...
        public ChannelMessageHandlers? ChannelMessageHandlers { get { int o = __p.__offset(10); return o != 0 ? (ChannelMessageHandlers?)(new ChannelMessageHandlers()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
        public Dump? Liburing { get { int o = __p.__offset(12); return o != 0 ? (Dump?)(new Dump()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
        ...
        public static Offset<DumpResponse> CreateDumpResponse(FlatBufferBuilder builder,
                                                              ...
                                                              Offset<ChannelMessageHandlers> channel_message_handlersOffset = default(Offset<ChannelMessageHandlers>),
                                                              Offset<Dump> liburingOffset = default(Offset<Dump>))
        {
        ...
        public static void AddChannelMessageHandlers(FlatBufferBuilder builder, Offset<ChannelMessageHandlers> channelMessageHandlersOffset) { builder.AddOffset(3, channelMessageHandlersOffset.Value, 0); }
        public static void AddLiburing(FlatBufferBuilder builder, Offset<Dump> liburingOffset) { builder.AddOffset(4, liburingOffset.Value, 0); }
        ...
        public static Offset<DumpResponse> Pack(FlatBufferBuilder builder, DumpResponseT _o)
        {
            ...
            var _channel_message_handlers = _o.ChannelMessageHandlers == null ? default(Offset<ChannelMessageHandlers>) : Worker.ChannelMessageHandlers.Pack(builder, _o.ChannelMessageHandlers);
            var _liburing = _o.Liburing == null ? default(Offset<Dump>) : Dump.Pack(builder, _o.Liburing);
