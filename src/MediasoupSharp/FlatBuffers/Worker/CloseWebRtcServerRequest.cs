...
namespace FlatBuffers.Worker
{
  ...
  public Span<byte> GetWebRtcServerIdBytes() { return __p.__vector_as_span<byte>(4, 1); }
        ...
        public static Offset<CloseWebRtcServerRequest> CreateCloseWebRtcServerRequest(FlatBufferBuilder builder,
        ...
        public static Offset<CloseWebRtcServerRequest> EndCloseWebRtcServerRequest(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // web_rtc_server_id
            return new Offset<CloseWebRtcServerRequest>(o);
        }
        ...
        public static Offset<CloseWebRtcServerRequest> Pack(FlatBufferBuilder builder, CloseWebRtcServerRequestT _o)
        {
            if(_o == null)
                return default(Offset<CloseWebRtcServerRequest>);
