...
namespace FlatBuffers.Worker
{
  ...
  public Span<byte> GetRouterIdBytes() { return __p.__vector_as_span<byte>(4, 1); }
        ...
        public static Offset<CreateRouterRequest> CreateCreateRouterRequest(FlatBufferBuilder builder,
        ...
        public static Offset<CreateRouterRequest> EndCreateRouterRequest(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // router_id
            return new Offset<CreateRouterRequest>(o);
        }
        ...
        public static Offset<CreateRouterRequest> Pack(FlatBufferBuilder builder, CreateRouterRequestT _o)
        {
            if(_o == null)
                return default(Offset<CreateRouterRequest>);
