...
namespace FlatBuffers.ActiveSpeakerObserver
{
  ...
  public Span<byte> GetProducerIdBytes() { return __p.__vector_as_span<byte>(4, 1); }
        ...
        public static Offset<DominantSpeakerNotification> CreateDominantSpeakerNotification(FlatBufferBuilder builder,
        ...
        public static Offset<DominantSpeakerNotification> EndDominantSpeakerNotification(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // producer_id
            return new Offset<DominantSpeakerNotification>(o);
        }
        ...
        public static Offset<DominantSpeakerNotification> Pack(FlatBufferBuilder builder, DominantSpeakerNotificationT _o)
        {
            if(_o == null)
                return default(Offset<DominantSpeakerNotification>);
