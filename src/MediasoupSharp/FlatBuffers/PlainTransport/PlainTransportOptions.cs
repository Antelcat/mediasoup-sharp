...
namespace FlatBuffers.PlainTransport
{
    public struct PlainTransportOptions : IFlatbufferObject
    {
        ...
        public ListenInfo? ListenInfo { get { int o = __p.__offset(6); return o != 0 ? (ListenInfo?)(new ListenInfo()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
        public ListenInfo? RtcpListenInfo { get { int o = __p.__offset(8); return o != 0 ? (ListenInfo?)(new ListenInfo()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
        ...
        public SrtpCryptoSuite? SrtpCryptoSuite { get { int o = __p.__offset(16); return o != 0 ? (SrtpCryptoSuite)__p.bb.Get(o + __p.bb_pos) : (SrtpCryptoSuite?)null; } }

        public static Offset<PlainTransportOptions> CreatePlainTransportOptions(FlatBufferBuilder builder,
                                                                                Offset<Options> @baseOffset = default(Offset<Options>),
                                                                                Offset<ListenInfo> listen_infoOffset = default(Offset<ListenInfo>),
                                                                                Offset<ListenInfo> rtcp_listen_infoOffset = default(Offset<ListenInfo>),
                                                                                bool rtcp_mux = false,
                                                                                bool comedia = false,
                                                                                bool enable_srtp = false,
                                                                                SrtpCryptoSuite? srtp_crypto_suite = null)
        {
        ...
        public static void AddListenInfo(FlatBufferBuilder builder, Offset<ListenInfo> listenInfoOffset) { builder.AddOffset(1, listenInfoOffset.Value, 0); }
        public static void AddRtcpListenInfo(FlatBufferBuilder builder, Offset<ListenInfo> rtcpListenInfoOffset) { builder.AddOffset(2, rtcpListenInfoOffset.Value, 0); }
        ...
        public static void AddSrtpCryptoSuite(FlatBufferBuilder builder, SrtpCryptoSuite? srtpCryptoSuite) { builder.AddByte(6, (byte?)srtpCryptoSuite); }
        public static Offset<PlainTransportOptions> EndPlainTransportOptions(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // base
            builder.Required(o, 6);  // listen_info
            return new Offset<PlainTransportOptions>(o);
        }
        ...
        public static Offset<PlainTransportOptions> Pack(FlatBufferBuilder builder, PlainTransportOptionsT _o)
        {
            if(_o == null)
                return default(Offset<PlainTransportOptions>);
            var _base = _o.Base == null ? default(Offset<Options>) : Options.Pack(builder, _o.Base);
            var _listen_info = _o.ListenInfo == null ? default(Offset<ListenInfo>) : Transport.ListenInfo.Pack(builder, _o.ListenInfo);
            var _rtcp_listen_info = _o.RtcpListenInfo == null ? default(Offset<ListenInfo>) : Transport.ListenInfo.Pack(builder, _o.RtcpListenInfo);
