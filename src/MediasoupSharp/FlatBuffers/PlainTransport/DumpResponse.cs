...
namespace FlatBuffers.PlainTransport
{
    ...
    public struct DumpResponse : IFlatbufferObject
    {
        ...
        public SrtpParameters.SrtpParameters? SrtpParameters { get { int o = __p.__offset(14); return o != 0 ? (SrtpParameters.SrtpParameters?)(new SrtpParameters.SrtpParameters()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
        ...
        public static void AddSrtpParameters(FlatBufferBuilder builder, Offset<SrtpParameters.SrtpParameters> srtpParametersOffset) { builder.AddOffset(5, srtpParametersOffset.Value, 0); }
