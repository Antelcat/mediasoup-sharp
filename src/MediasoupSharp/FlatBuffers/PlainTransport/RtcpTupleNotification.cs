...
namespace FlatBuffers.PlainTransport
{
    ...
    public struct RtcpTupleNotification : IFlatbufferObject
    {
        ...
        public static Offset<RtcpTupleNotification> CreateRtcpTupleNotification(FlatBufferBuilder builder,
        ...
        public static Offset<RtcpTupleNotification> EndRtcpTupleNotification(FlatBufferBuilder builder)
        {
            int o = builder.EndTable();
            builder.Required(o, 4);  // tuple
            return new Offset<RtcpTupleNotification>(o);
        }
        ...
        public static Offset<RtcpTupleNotification> Pack(FlatBufferBuilder builder, RtcpTupleNotificationT _o)
        {
            if(_o == null)
                return default(Offset<RtcpTupleNotification>);
