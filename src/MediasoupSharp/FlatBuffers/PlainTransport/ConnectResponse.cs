...
namespace FlatBuffers.PlainTransport
{
    ...
    public struct ConnectResponse : IFlatbufferObject
    {
        ...
        public Tuple? RtcpTuple { get { int o = __p.__offset(6); return o != 0 ? (Tuple?)(new Tuple()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
        public SrtpParameters.SrtpParameters? SrtpParameters { get { int o = __p.__offset(8); return o != 0 ? (SrtpParameters.SrtpParameters?)(new SrtpParameters.SrtpParameters()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
        ...
        public static void AddRtcpTuple(FlatBufferBuilder builder, Offset<Tuple> rtcpTupleOffset) { builder.AddOffset(1, rtcpTupleOffset.Value, 0); }
        public static void AddSrtpParameters(FlatBufferBuilder builder, Offset<SrtpParameters.SrtpParameters> srtpParametersOffset) { builder.AddOffset(2, srtpParametersOffset.Value, 0); }
